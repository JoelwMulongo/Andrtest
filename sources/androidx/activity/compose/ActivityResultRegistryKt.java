...
public final class ActivityResultRegistryKt {
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> contract, Function1<? super O, Unit> onResult, Composer $composer, int $changed) {
        ...
        Function1<? super O, Unit> function1 = onResult;
        ...
        Object rememberSaveable = RememberSaveableKt.rememberSaveable(new Object[0], (Saver) null, (String) null, ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1.INSTANCE, $composer, 3080, 6);
        Intrinsics.checkNotNullExpressionValue(rememberSaveable, "rememberSaveable { UUID.randomUUID().toString() }");
        String key = (String) rememberSaveable;

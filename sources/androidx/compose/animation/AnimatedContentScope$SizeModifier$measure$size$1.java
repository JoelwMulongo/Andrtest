...
final class AnimatedContentScope$SizeModifier$measure$size$1 extends Lambda implements Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> {
    ...
    public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> $this$animate) {
        ...
        long initial = state != null ? ((IntSize) state.getValue()).m6150unboximpl() : IntSize.Companion.m6151getZeroYbymL2g();
        State state2 = this.this$0.getTargetSizeMap$animation_release().get($this$animate.getTargetState());
        long target = state2 != null ? ((IntSize) state2.getValue()).m6150unboximpl() : IntSize.Companion.m6151getZeroYbymL2g();
        SizeTransform value = this.this$1.getSizeTransform().getValue();
        return (value == null || (r4 = value.m371createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, (Object) null, 7, (Object) null) : r4;
    }
}

...
final class AnimatedContentScope$SizeModifier$measure$size$2 extends Lambda implements Function1<S, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntSize.m6138boximpl(m318invokeYEO4UFw(p1));
    }

    /* renamed from: invoke-YEO4UFw  reason: not valid java name */
    public final long m318invokeYEO4UFw(S it) {
        State state = this.this$0.getTargetSizeMap$animation_release().get(it);
        return state != null ? ((IntSize) state.getValue()).m6150unboximpl() : IntSize.Companion.m6151getZeroYbymL2g();
    }
}

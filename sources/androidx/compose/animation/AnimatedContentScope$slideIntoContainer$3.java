...
final class AnimatedContentScope$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m6104getXimpl(this.this$0.m307calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.this$0.m308getCurrentSizeYbymL2g()))) - it));
    }
}

...
final class AnimatedContentScope$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m6105getYimpl(this.this$0.m307calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), state != null ? ((IntSize) state.getValue()).m6150unboximpl() : IntSize.Companion.m6151getZeroYbymL2g()))) - it));
    }
}

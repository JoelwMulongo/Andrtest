...
final class EnterExitTransitionKt$shrinkHorizontally$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntSize.m6138boximpl(m345invokemzRDjE0(((IntSize) p1).m6150unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m345invokemzRDjE0(long it) {
        return IntSizeKt.IntSize(this.$targetWidth.invoke(Integer.valueOf(IntSize.m6146getWidthimpl(it))).intValue(), IntSize.m6145getHeightimpl(it));
    }
}

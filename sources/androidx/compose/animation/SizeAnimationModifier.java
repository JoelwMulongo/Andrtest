...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final class AnimData {
        ...
        public static /* synthetic */ AnimData m366copyO0kMr_c$default(AnimData animData, Animatable<IntSize, AnimationVector2D> animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m368copyO0kMr_c(animatable, j);
        }
        ...
        public final long m367component2YbymL2g() {
            return this.startSize;
        }

        /* renamed from: copy-O0kMr_c  reason: not valid java name */
        public final AnimData m368copyO0kMr_c(Animatable<IntSize, AnimationVector2D> animatable, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.anim, (Object) animData.anim) && IntSize.m6144equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6147hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + IntSize.m6149toStringimpl(this.startSize) + ')';
        }
        ...
        public final long m369getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI  reason: not valid java name */
        public final void m370setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult m365measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long r3 = m364animateTomzRDjE0(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6146getWidthimpl(r3), IntSize.m6145getHeightimpl(r3), (Map) null, new SizeAnimationModifier$measure$1(placeable), 4, (Object) null);
    }

    /* renamed from: animateTo-mzRDjE0  reason: not valid java name */
    public final long m364animateTomzRDjE0(long targetSize) {
        long j = targetSize;
        AnimData animData = getAnimData();
        if (animData != null) {
            AnimData $this$animateTo_mzRDjE0_u24lambda_u240 = animData;
            if (!IntSize.m6144equalsimpl0(j, $this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getTargetValue().m6150unboximpl())) {
                $this$animateTo_mzRDjE0_u24lambda_u240.m370setStartSizeozmzZPI($this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getValue().m6150unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m6138boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m6138boximpl(IntSizeKt.IntSize(1, 1)), (String) null, 8, (DefaultConstructorMarker) null), j, (DefaultConstructorMarker) null);
        }
        AnimData data = animData;
        setAnimData(data);
        return data.getAnim().getValue().m6150unboximpl();
    }
}

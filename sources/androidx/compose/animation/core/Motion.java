...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m393boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m397equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m403unboximpl();
    }
    ...
    public static String m402toStringimpl(long j) {
        return "Motion(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m397equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m401hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m402toStringimpl(this.packedValue);
    }
    ...
    public static final float m399getValueimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getVelocity-impl  reason: not valid java name */
    public static final float m400getVelocityimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: copy-XB9eQnU  reason: not valid java name */
    public static final long m395copyXB9eQnU(long arg0, float value, float velocity) {
        return SpringSimulationKt.Motion(value, velocity);
    }

    /* renamed from: copy-XB9eQnU$default  reason: not valid java name */
    public static /* synthetic */ long m396copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m399getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m400getVelocityimpl(j);
        }
        return m395copyXB9eQnU(j, f, f2);
    }
}

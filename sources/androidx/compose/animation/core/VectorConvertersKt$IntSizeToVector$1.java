...
final class VectorConvertersKt$IntSizeToVector$1 extends Lambda implements Function1<IntSize, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m432invokeozmzZPI(((IntSize) p1).m6150unboximpl());
    }

    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
    public final AnimationVector2D m432invokeozmzZPI(long it) {
        return new AnimationVector2D((float) IntSize.m6146getWidthimpl(it), (float) IntSize.m6145getHeightimpl(it));
    }
}

...
final class BorderKt$drawRectBorder$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope $this$onDrawWithContent) {
        ...
        DrawScope.m3747drawRectAsUm42w$default($this$onDrawWithContent, this.$brush, this.$rectTopLeft, this.$size, 0.0f, this.$style, (ColorFilter) null, 0, LocationRequestCompat.QUALITY_LOW_POWER, (Object) null);
    }
}

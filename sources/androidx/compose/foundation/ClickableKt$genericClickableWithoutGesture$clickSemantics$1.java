...
final class ClickableKt$genericClickableWithoutGesture$clickSemantics$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public final void invoke(SemanticsPropertyReceiver $this$semantics) {
        ...
        Role role = this.$role;
        if (role != null) {
            SemanticsPropertiesKt.m5327setRolekuIjeqM($this$semantics, role.m5312unboximpl());
        }
        String str = this.$onClickLabel;
        final Function0<Unit> function0 = this.$onClick;
        SemanticsPropertiesKt.onClick($this$semantics, str, new Function0<Boolean>() {
        ...
        if (this.$onLongClick != null) {
            ...
            SemanticsPropertiesKt.onLongClick($this$semantics, str2, new Function0<Boolean>() {
                public final Boolean invoke() {
                    function02.invoke();
                    return true;
                }

...
final class ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m487invokeZmokQxo(((KeyEvent) p1).m4513unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m487invokeZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        boolean z = true;
        if (!this.$enabled || !Clickable_androidKt.m490isPressZmokQxo(keyEvent)) {
            if (!this.$enabled || !Clickable_androidKt.m488isClickZmokQxo(keyEvent)) {
                z = false;
            } else {
                PressInteraction.Press it = this.$currentKeyPressInteractions.remove(Key.m3926boximpl(KeyEvent_androidKt.m4524getKeyZmokQxo(keyEvent)));
                if (it != null) {
        ...
        } else if (!this.$currentKeyPressInteractions.containsKey(Key.m3926boximpl(KeyEvent_androidKt.m4524getKeyZmokQxo(keyEvent)))) {
            final PressInteraction.Press press = new PressInteraction.Press(this.$keyClickOffset.getValue().m2925unboximpl(), (DefaultConstructorMarker) null);
            this.$currentKeyPressInteractions.put(Key.m3926boximpl(KeyEvent_androidKt.m4524getKeyZmokQxo(keyEvent)), press);

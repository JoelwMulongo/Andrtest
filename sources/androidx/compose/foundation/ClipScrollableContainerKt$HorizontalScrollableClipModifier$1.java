...
public final class ClipScrollableContainerKt$HorizontalScrollableClipModifier$1 implements Shape {
    ...
    public Outline m491createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -inflateSize, Size.m2984getWidthimpl(size), Size.m2981getHeightimpl(size) + inflateSize));
    }
}

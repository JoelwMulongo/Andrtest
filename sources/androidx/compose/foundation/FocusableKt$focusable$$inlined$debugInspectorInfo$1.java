...
public final class FocusableKt$focusable$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$focusable_u24lambda_u240 = $this$null;
        $this$focusable_u24lambda_u240.setName("focusable");
        $this$focusable_u24lambda_u240.getProperties().set("enabled", Boolean.valueOf(this.$enabled$inlined));
        $this$focusable_u24lambda_u240.getProperties().set("interactionSource", this.$interactionSource$inlined);
    }
}

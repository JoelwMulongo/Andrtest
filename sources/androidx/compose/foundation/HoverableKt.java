...
public final class HoverableKt {
    ...
    public static final Modifier hoverable(Modifier $this$hoverable, MutableInteractionSource interactionSource, boolean enabled) {
        ...
        return ComposedModifierKt.composed($this$hoverable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new HoverableKt$hoverable$$inlined$debugInspectorInfo$1(interactionSource, enabled) : InspectableValueKt.getNoInspectorInfo(), new HoverableKt$hoverable$2(interactionSource, enabled));
    }
}

...
public final class MarqueeAnimationMode {
    ...
    public static final int Immediately = m502constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int WhileFocused = m502constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m501boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m502constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m503equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m507unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m504equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m505hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m503equalsimpl(this.value, obj);
    }
    ...
    public static String m506toStringimpl(int arg0) {
        if (m504equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m504equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m508getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m509getWhileFocusedZbEOnfQ$annotations() {
        }

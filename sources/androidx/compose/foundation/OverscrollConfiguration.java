...
public final class OverscrollConfiguration {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m755PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, (Object) null) : paddingValues, (DefaultConstructorMarker) null);
    }

    /* renamed from: getGlowColor-0d7_KjU  reason: not valid java name */
    public final long m517getGlowColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3165equalsimpl0(this.glowColor, ((OverscrollConfiguration) other).glowColor) && Intrinsics.areEqual((Object) this.drawPadding, (Object) ((OverscrollConfiguration) other).drawPadding)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Color.m3171hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + Color.m3172toStringimpl(this.glowColor) + ", drawPadding=" + this.drawPadding + ')';
    }
}

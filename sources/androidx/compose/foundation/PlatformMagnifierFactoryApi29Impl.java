...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float initialZoom) {
        ...
        long size = $this$create_u24lambda_u241.m5968toSizeXkaWNTQ(style.m500getSizeMYxV2XQ$foundation_release());
        float cornerRadius = $this$create_u24lambda_u241.m5967toPx0680j_4(style.m498getCornerRadiusD9Ej5fM$foundation_release());
        float elevation = $this$create_u24lambda_u241.m5967toPx0680j_4(style.m499getElevationD9Ej5fM$foundation_release());
        Magnifier.Builder $this$create_u24lambda_u241_u24lambda_u240 = new Magnifier.Builder(view2);
        if (size != Size.Companion.m2992getUnspecifiedNHjbRc()) {
            $this$create_u24lambda_u241_u24lambda_u240.setSize(MathKt.roundToInt(Size.m2984getWidthimpl(size)), MathKt.roundToInt(Size.m2981getHeightimpl(size)));
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void m524updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
                getMagnifier().setZoom(zoom);
            }
            if (OffsetKt.m2934isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m2915getXimpl(sourceCenter), Offset.m2916getYimpl(sourceCenter), Offset.m2915getXimpl(magnifierCenter), Offset.m2916getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m2915getXimpl(sourceCenter), Offset.m2916getYimpl(sourceCenter));
            }
        }
    }
}

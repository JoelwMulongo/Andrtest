...
public final class DragGestureDetectorKt$HorizontalPointerDirectionConfig$1 implements PointerDirectionConfig {
    ...
    public float m560mainAxisDeltak4lQ0M(long offset) {
        return Offset.m2915getXimpl(offset);
    }

    /* renamed from: crossAxisDelta-k-4lQ0M  reason: not valid java name */
    public float m559crossAxisDeltak4lQ0M(long offset) {
        return Offset.m2916getYimpl(offset);
    }

    /* renamed from: offsetFromChanges-dBAh8RU  reason: not valid java name */
    public long m561offsetFromChangesdBAh8RU(float mainChange, float crossChange) {

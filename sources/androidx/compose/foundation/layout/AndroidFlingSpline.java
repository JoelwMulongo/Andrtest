...
final class AndroidFlingSpline {
    ...
    public final long m667flingPositionLfoxSSI(float time) {
        float f = (float) 100;
        ...
        return FlingResult.m669constructorimpl((((long) Float.floatToIntBits(distanceCoef)) << 32) | (4294967295L & ((long) Float.floatToIntBits(velocityCoef))));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m668boximpl(long j) {
        ...
        public static boolean m670equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m676unboximpl();
        }
        ...
        public static String m675toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m670equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m674hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m675toStringimpl(this.packedValue);
        }
        ...
        public static final float m672getDistanceCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (arg0 >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m673getVelocityCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;

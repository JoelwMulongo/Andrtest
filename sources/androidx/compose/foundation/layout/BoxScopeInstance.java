...
public final class BoxScopeInstance implements BoxScope {
    ...
    public Modifier align(Modifier $this$align, Alignment alignment) {
        ...
        return $this$align.then(new BoxChildData(alignment, false, InspectableValueKt.isDebugInspectorInfoEnabled() ? new BoxScopeInstance$align$$inlined$debugInspectorInfo$1(alignment) : InspectableValueKt.getNoInspectorInfo()));
    }

    public Modifier matchParentSize(Modifier $this$matchParentSize) {
        Intrinsics.checkNotNullParameter($this$matchParentSize, "<this>");
        return $this$matchParentSize.then(new BoxChildData(Alignment.Companion.getCenter(), true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new BoxScopeInstance$matchParentSize$$inlined$debugInspectorInfo$1() : InspectableValueKt.getNoInspectorInfo()));
    }
}

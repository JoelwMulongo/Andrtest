...
public final class ColumnScopeInstance$alignBy$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$alignBy_u24lambda_u243 = $this$null;
        $this$alignBy_u24lambda_u243.setName("alignBy");
        $this$alignBy_u24lambda_u243.setValue(this.$alignmentLine$inlined);
    }
}

...
public final class OffsetKt$absoluteOffsetVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$absoluteOffset_VpY3zN4_u24lambda_u241 = $this$null;
        $this$absoluteOffset_VpY3zN4_u24lambda_u241.setName("absoluteOffset");
        $this$absoluteOffset_VpY3zN4_u24lambda_u241.getProperties().set("x", Dp.m5984boximpl(this.$x$inlined));
        $this$absoluteOffset_VpY3zN4_u24lambda_u241.getProperties().set("y", Dp.m5984boximpl(this.$y$inlined));
    }
}

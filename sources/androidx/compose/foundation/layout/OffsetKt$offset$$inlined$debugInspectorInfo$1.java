...
public final class OffsetKt$offset$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$offset_u24lambda_u242 = $this$null;
        $this$offset_u24lambda_u242.setName("offset");
        $this$offset_u24lambda_u242.getProperties().set("offset", this.$offset$inlined);
    }
}

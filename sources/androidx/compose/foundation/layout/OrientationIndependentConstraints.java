...
public final class OrientationIndependentConstraints {
    ...
    public OrientationIndependentConstraints(int mainAxisMin2, int mainAxisMax2, int crossAxisMin2, int crossAxisMax2) {
        this.mainAxisMin = mainAxisMin2;
        this.mainAxisMax = mainAxisMax2;
        this.crossAxisMin = crossAxisMin2;
        this.crossAxisMax = crossAxisMax2;
    }
    ...
    private OrientationIndependentConstraints(long c, LayoutOrientation orientation) {
        this(orientation == LayoutOrientation.Horizontal ? Constraints.m5932getMinWidthimpl(c) : Constraints.m5931getMinHeightimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5930getMaxWidthimpl(c) : Constraints.m5929getMaxHeightimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5931getMinHeightimpl(c) : Constraints.m5932getMinWidthimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5929getMaxHeightimpl(c) : Constraints.m5930getMaxWidthimpl(c));
    }
    ...
    public final long m752toBoxConstraintsOenEA2s(LayoutOrientation orientation) {

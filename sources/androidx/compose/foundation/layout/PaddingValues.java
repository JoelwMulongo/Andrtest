...
public interface PaddingValues {
    ...
    float m770calculateBottomPaddingD9Ej5fM();

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    float m771calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    float m772calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    float m773calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m774getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m775getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m776getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m777getTopD9Ej5fM$annotations() {
        }
        ...
        public /* synthetic */ Absolute(float r7, float r8, float r9, float r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
            /*
                ...
                r12 = 0
                float r0 = (float) r7
                float r7 = androidx.compose.ui.unit.Dp.m5986constructorimpl(r0)
                r1 = r7
                goto L_0x000e
            L_0x000d:
                r1 = r7
            ...
            L_0x002a:
                ...
                r8 = 0
                float r9 = (float) r7
                float r10 = androidx.compose.ui.unit.Dp.m5986constructorimpl(r9)
                r4 = r10
                goto L_0x0038
            L_0x0037:
                r4 = r10
        ...
        /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
        public float m779calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.left;
        }

        /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
        public float m781calculateTopPaddingD9Ej5fM() {
            return this.top;
        }

        /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
        public float m780calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }

        /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
        public float m778calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }

        public boolean equals(Object other) {
            if ((other instanceof Absolute) && Dp.m5991equalsimpl0(this.left, ((Absolute) other).left) && Dp.m5991equalsimpl0(this.top, ((Absolute) other).top) && Dp.m5991equalsimpl0(this.right, ((Absolute) other).right) && Dp.m5991equalsimpl0(this.bottom, ((Absolute) other).bottom)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + Dp.m5997toStringimpl(this.left) + ", top=" + Dp.m5997toStringimpl(this.top) + ", right=" + Dp.m5997toStringimpl(this.right) + ", bottom=" + Dp.m5997toStringimpl(this.bottom) + ')';
        }
    }
}

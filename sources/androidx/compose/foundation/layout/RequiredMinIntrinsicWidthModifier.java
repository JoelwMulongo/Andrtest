...
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m798calculateContentConstraintsl58MMJ0(MeasureScope $this$calculateContentConstraints_u2dl58MMJ0, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$calculateContentConstraints_u2dl58MMJ0, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5940fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m5929getMaxHeightimpl(constraints)));
    }

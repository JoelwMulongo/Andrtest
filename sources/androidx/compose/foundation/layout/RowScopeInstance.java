...
public final class RowScopeInstance implements RowScope {
    ...
    public Modifier weight(Modifier $this$weight, float weight, boolean fill) {
        ...
        if (((double) weight) > 0.0d) {
            return $this$weight.then(new LayoutWeightImpl(weight, fill, InspectableValueKt.isDebugInspectorInfoEnabled() ? new RowScopeInstance$weight$$inlined$debugInspectorInfo$1(weight, fill) : InspectableValueKt.getNoInspectorInfo()));
        }
    ...
    public Modifier align(Modifier $this$align, Alignment.Vertical alignment) {
        ...
        return $this$align.then(new VerticalAlignModifier(alignment, InspectableValueKt.isDebugInspectorInfoEnabled() ? new RowScopeInstance$align$$inlined$debugInspectorInfo$1(alignment) : InspectableValueKt.getNoInspectorInfo()));
    }
    ...
    public Modifier alignBy(Modifier $this$alignBy, HorizontalAlignmentLine alignmentLine) {
        ...
        return $this$alignBy.then(new SiblingsAlignedModifier.WithAlignmentLine(alignmentLine, InspectableValueKt.isDebugInspectorInfoEnabled() ? new RowScopeInstance$alignBy$$inlined$debugInspectorInfo$1(alignmentLine) : InspectableValueKt.getNoInspectorInfo()));
    }
    ...
    public Modifier alignBy(Modifier $this$alignBy, Function1<? super Measured, Integer> alignmentLineBlock) {
        ...
        return $this$alignBy.then(new SiblingsAlignedModifier.WithAlignmentLineBlock(alignmentLineBlock, InspectableValueKt.isDebugInspectorInfoEnabled() ? new RowScopeInstance$alignBy$$inlined$debugInspectorInfo$2(alignmentLineBlock) : InspectableValueKt.getNoInspectorInfo()));
    }
}

...
public final class SideCalculator$Companion$LeftSideCalculator$1 implements SideCalculator {
    ...
    public long m808consumedOffsetsMKHz9U(long available) {
        return OffsetKt.Offset(Offset.m2915getXimpl(available), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m809consumedVelocityQWom1Mo(long available, float remaining) {
        return VelocityKt.Velocity(Velocity.m6211getXimpl(available) - remaining, 0.0f);
    }
}

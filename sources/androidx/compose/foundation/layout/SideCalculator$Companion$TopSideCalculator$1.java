...
public final class SideCalculator$Companion$TopSideCalculator$1 implements SideCalculator {
    ...
    public long m812consumedOffsetsMKHz9U(long available) {
        return OffsetKt.Offset(0.0f, Offset.m2916getYimpl(available));
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m813consumedVelocityQWom1Mo(long available, float remaining) {
        return VelocityKt.Velocity(0.0f, Velocity.m6212getYimpl(available) - remaining);
    }
}

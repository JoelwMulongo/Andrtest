...
interface SideCalculator {
    ...
    long m803consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long m804consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        public final SideCalculator m805chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m875getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m878getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m876getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m872getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m877getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (!WindowInsetsSides.m861equalsimpl0(side, WindowInsetsSides.Companion.m873getEndJoeWqyM())) {

...
final class WrapContentModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        Placeable.PlacementScope.m4903place70tqf50$default(placementScope, this.$placeable, ((IntOffset) this.this$0.alignmentCallback.invoke(IntSize.m6138boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection())).m6113unboximpl(), 0.0f, 2, (Object) null);
    }
}

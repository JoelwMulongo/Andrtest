...
public final class LazyItemScopeImpl$animateItemPlacement$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$animateItemPlacement_u24lambda_u243 = $this$null;
        $this$animateItemPlacement_u24lambda_u243.setName("animateItemPlacement");
        $this$animateItemPlacement_u24lambda_u243.setValue(this.$animationSpec$inlined);
    }
}

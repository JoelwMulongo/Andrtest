...
public final class LazyItemScopeImpl$fillParentMaxHeight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$fillParentMaxHeight_u24lambda_u242 = $this$null;
        $this$fillParentMaxHeight_u24lambda_u242.setName("fillParentMaxHeight");
        $this$fillParentMaxHeight_u24lambda_u242.setValue(Float.valueOf(this.$fraction$inlined));
    }
}

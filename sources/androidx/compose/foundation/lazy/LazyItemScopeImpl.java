...
public final class LazyItemScopeImpl implements LazyItemScope {
    ...
    public Modifier fillParentMaxSize(Modifier $this$fillParentMaxSize, float fraction) {
        ...
        return $this$fillParentMaxSize.then(new ParentSizeModifier(fraction, InspectableValueKt.isDebugInspectorInfoEnabled() ? new LazyItemScopeImpl$fillParentMaxSize$$inlined$debugInspectorInfo$1(fraction) : InspectableValueKt.getNoInspectorInfo(), this.maxWidthState, this.maxHeightState));
    }
    ...
    public Modifier fillParentMaxWidth(Modifier $this$fillParentMaxWidth, float fraction) {
        ...
        return $this$fillParentMaxWidth.then(new ParentSizeModifier(fraction, InspectableValueKt.isDebugInspectorInfoEnabled() ? new LazyItemScopeImpl$fillParentMaxWidth$$inlined$debugInspectorInfo$1(fraction) : InspectableValueKt.getNoInspectorInfo(), this.maxWidthState, (State) null, 8, (DefaultConstructorMarker) null));
    }
    ...
    public Modifier fillParentMaxHeight(Modifier $this$fillParentMaxHeight, float fraction) {
        ...
        return $this$fillParentMaxHeight.then(new ParentSizeModifier(fraction, InspectableValueKt.isDebugInspectorInfoEnabled() ? new LazyItemScopeImpl$fillParentMaxHeight$$inlined$debugInspectorInfo$1(fraction) : InspectableValueKt.getNoInspectorInfo(), (State) null, this.maxHeightState, 4, (DefaultConstructorMarker) null));
    }
    ...
    public Modifier animateItemPlacement(Modifier $this$animateItemPlacement, FiniteAnimationSpec<IntOffset> animationSpec) {
        ...
        return $this$animateItemPlacement.then(new AnimateItemPlacementModifier(animationSpec, InspectableValueKt.isDebugInspectorInfoEnabled() ? new LazyItemScopeImpl$animateItemPlacement$$inlined$debugInspectorInfo$1(animationSpec) : InspectableValueKt.getNoInspectorInfo()));
    }
}

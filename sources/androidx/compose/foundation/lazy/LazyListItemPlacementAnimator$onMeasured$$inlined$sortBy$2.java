...
public final class LazyListItemPlacementAnimator$onMeasured$$inlined$sortBy$2<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues((Integer) this.this$0.keyToIndexMap.get(((LazyMeasuredItem) a).getKey()), (Integer) this.this$0.keyToIndexMap.get(((LazyMeasuredItem) b).getKey()));
    }
}

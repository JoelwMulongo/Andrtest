...
public final class LazyGridItemPlacementAnimator$onMeasured$$inlined$sortBy$1<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues((Integer) this.$previousKeyToIndexMap$inlined.get(((LazyGridPositionedItem) a).getKey()), (Integer) this.$previousKeyToIndexMap$inlined.get(((LazyGridPositionedItem) b).getKey()));
    }
}

...
public final class LazyGridItemPlacementAnimator$onMeasured$$inlined$sortByDescending$2<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues((Integer) this.this$0.keyToIndexMap.get(((LazyGridMeasuredItem) b).getKey()), (Integer) this.this$0.keyToIndexMap.get(((LazyGridMeasuredItem) a).getKey()));
    }
}

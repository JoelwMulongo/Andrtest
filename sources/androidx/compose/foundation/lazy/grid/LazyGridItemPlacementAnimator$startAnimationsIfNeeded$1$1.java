...
final class LazyGridItemPlacementAnimator$startAnimationsIfNeeded$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r13) {
        ...
        L_0x0018:
            ...
            r1 = r12
            androidx.compose.foundation.lazy.grid.PlaceableInfo r2 = r1.$placeableInfo
            ...
            goto L_0x0035
        L_0x0031:
            androidx.compose.animation.core.SpringSpec r2 = androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimatorKt.InterruptionSpec
        L_0x0035:
        ...
        L_0x0038:
            androidx.compose.animation.core.FiniteAnimationSpec<androidx.compose.ui.unit.IntOffset> r2 = r1.$animationSpec
        L_0x003a:
            androidx.compose.foundation.lazy.grid.PlaceableInfo r3 = r1.$placeableInfo     // Catch:{ CancellationException -> 0x0069 }
            androidx.compose.animation.core.Animatable r4 = r3.getAnimatedOffset()     // Catch:{ CancellationException -> 0x0069 }
            androidx.compose.foundation.lazy.grid.PlaceableInfo r3 = r1.$placeableInfo     // Catch:{ CancellationException -> 0x0069 }
            long r5 = r3.m1001getTargetOffsetnOccac()     // Catch:{ CancellationException -> 0x0069 }
        ...
        L_0x0061:
            r0 = r1
        L_0x0062:
            androidx.compose.foundation.lazy.grid.PlaceableInfo r1 = r0.$placeableInfo     // Catch:{ CancellationException -> 0x0016 }
            r2 = 0
        ...
        L_0x006b:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimator$startAnimationsIfNeeded$1$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}

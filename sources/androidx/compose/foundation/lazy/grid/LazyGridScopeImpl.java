...
public final class LazyGridScopeImpl implements LazyGridScope {
    ...
    public void item(Object key, Function1<? super LazyGridItemSpanScope, GridItemSpan> span, Object contentType, Function3<? super LazyGridItemScope, ? super Composer, ? super Integer, Unit> content) {
        ...
        if (key != null) {
            Object obj = key;
            function1 = new LazyGridScopeImpl$item$1$1(key);
        } else {
            function1 = null;
        }
        if (span != null) {
            Function1<? super LazyGridItemSpanScope, GridItemSpan> function12 = span;
            function2 = new LazyGridScopeImpl$item$2$1(span);
        } else {
            function2 = this.DefaultSpan;
        }
        mutableIntervalList.addInterval(1, new LazyGridIntervalContent(function1, function2, new LazyGridScopeImpl$item$3(contentType), ComposableLambdaKt.composableLambdaInstance(-1504808184, true, new LazyGridScopeImpl$item$4(content))));
        if (span != null) {

...
final class PlaceableInfo {
    ...
    private PlaceableInfo(long initialOffset, int mainAxisSize2) {
        this.mainAxisSize = mainAxisSize2;
        this.animatedOffset = new Animatable(IntOffset.m6095boximpl(initialOffset), VectorConvertersKt.getVectorConverter(IntOffset.Companion), (Object) null, 4, (DefaultConstructorMarker) null);
    ...
    public final long m1001getTargetOffsetnOccac() {
        return this.targetOffset;
    }

    /* renamed from: setTargetOffset--gyyYBs  reason: not valid java name */
    public final void m1002setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }

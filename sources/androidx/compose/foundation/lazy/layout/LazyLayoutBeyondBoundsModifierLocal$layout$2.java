...
public final class LazyLayoutBeyondBoundsModifierLocal$layout$2 implements BeyondBoundsLayout.BeyondBoundsScope {
    ...
    LazyLayoutBeyondBoundsModifierLocal$layout$2(LazyLayoutBeyondBoundsModifierLocal $receiver, Ref.ObjectRef<LazyListBeyondBoundsInfo.Interval> $interval2, int $direction2) {
    ...
    public boolean getHasMoreContent() {
        return this.this$0.m1005hasMoreContentFR3nfPY((LazyListBeyondBoundsInfo.Interval) this.$interval.element, this.$direction);
    }
}

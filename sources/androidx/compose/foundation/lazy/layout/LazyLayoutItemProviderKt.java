...
public final class LazyLayoutItemProviderKt {
    ...
    public static final int findIndexByKey(LazyLayoutItemProvider $this$findIndexByKey, Object key, int lastKnownIndex) {
        ...
        if ((lastKnownIndex >= $this$findIndexByKey.getItemCount() || !Intrinsics.areEqual(key, $this$findIndexByKey.getKey(lastKnownIndex))) && (newIndex = $this$findIndexByKey.getKeyToIndexMap().get(key)) != null) {

...
public interface LazyLayoutMeasureScope extends MeasureScope {
    ...
    List<Placeable> m1009measure0kLqBqw(int i, long j);

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    float m1010toDpGaN1DYA(long $this$toDp_u2dGaN1DYA) {
    ...
    long m1013toDpSizekrfVVM(long $this$toDpSize_u2dk_u2drfVVM) {
        if ($this$toDpSize_u2dk_u2drfVVM != Size.Companion.m2992getUnspecifiedNHjbRc()) {
            return DpKt.m6008DpSizeYgX7TsA(m1011toDpu2uoSUM(Size.m2984getWidthimpl($this$toDpSize_u2dk_u2drfVVM)), m1011toDpu2uoSUM(Size.m2981getHeightimpl($this$toDpSize_u2dk_u2drfVVM)));
        }

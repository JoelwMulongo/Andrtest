...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle m1032schedulePrefetch0kLqBqw(int i, long j);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0006, code lost:
        r0 = r0.m1032schedulePrefetch0kLqBqw(r2, r3);
     */
    /* renamed from: schedulePrefetch-0kLqBqw  reason: not valid java name */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState.PrefetchHandle m1031schedulePrefetch0kLqBqw(int r2, long r3) {
        /*
            r1 = this;
            androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$Prefetcher r0 = r1.getPrefetcher$foundation_release()
            if (r0 == 0) goto L_0x000c
            androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$PrefetchHandle r0 = r0.m1032schedulePrefetch0kLqBqw(r2, r3)
        ...
        L_0x0010:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState.m1031schedulePrefetch0kLqBqw(int, long):androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$PrefetchHandle");
    }
}

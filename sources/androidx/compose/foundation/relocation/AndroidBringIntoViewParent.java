...
final class AndroidBringIntoViewParent implements BringIntoViewParent {
    ...
    public Object bringChildIntoView(LayoutCoordinates childCoordinates, Function0<Rect> boundsProvider, Continuation<? super Unit> $completion) {
        ...
        if (invoke == null || (rootRect = invoke.m2952translatek4lQ0M(childOffset)) == null) {
            return Unit.INSTANCE;
        }
        this.view.requestRectangleOnScreen(BringIntoViewResponder_androidKt.toRect(rootRect), false);
        return Unit.INSTANCE;
    }
}

...
final class ToggleableKt$triStateToggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier r0 = ToggleableKt.m1087triStateToggleableO2vRcR0(modifier, toggleableState, (MutableInteractionSource) value$iv$iv, (Indication) consume, this.$enabled, this.$role, this.$onClick);
        if (ComposerKt.isTraceInProgress()) {

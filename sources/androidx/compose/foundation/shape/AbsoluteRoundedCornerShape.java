...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline m1096createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        float f = topStart;
        float f2 = topEnd;
        float f3 = bottomEnd;
    ...
    private final long m1095toRadiusBz7bX_o(float $this$toRadius_u2dBz7bX_o) {

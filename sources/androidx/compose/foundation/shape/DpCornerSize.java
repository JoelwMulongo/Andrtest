...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m1109component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m1110copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m1111copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m1111copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m5991equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }

    public int hashCode() {
        return Dp.m5992hashCodeimpl(this.size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m5984boximpl(m1112getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m1113toPxTmRCtEA(long shapeSize, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5967toPx0680j_4(this.size);
    }
    ...
    public float m1112getValueOverrideD9Ej5fM() {
        return this.size;
    }
}

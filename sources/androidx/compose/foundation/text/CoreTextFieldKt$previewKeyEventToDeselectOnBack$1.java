...
final class CoreTextFieldKt$previewKeyEventToDeselectOnBack$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m1140invokeZmokQxo(((KeyEvent) p1).m4513unboximpl());
    }
    ...
    public final Boolean m1140invokeZmokQxo(android.view.KeyEvent keyEvent) {
        ...
        if (this.$state.getHandleState() != HandleState.Selection || !KeyEventHelpers_androidKt.m1148cancelsTextSelectionZmokQxo(keyEvent)) {
            z = false;
        } else {
            z = true;

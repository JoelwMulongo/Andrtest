...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m1147measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long childConstraints;
        MeasureScope measureScope = $this$measure_u2d3p2s80s;
        Measurable measurable2 = measurable;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable2, "measurable");
        if (measurable2.maxIntrinsicWidth(Constraints.m5929getMaxHeightimpl(constraints)) < Constraints.m5930getMaxWidthimpl(constraints)) {
            childConstraints = constraints;
        } else {
            childConstraints = Constraints.m5921copyZbe2FdA$default(constraints, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable placeable = measurable2.m4863measureBRTryo0(childConstraints);
        int width = Math.min(placeable.getWidth(), Constraints.m5930getMaxWidthimpl(constraints));

...
public final class TextFieldDelegate {
    ...
    public static final Triple<Integer, Integer, TextLayoutResult> m1205layout_EkL_Y$foundation_release(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
        return Companion.m1209layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult);
    }
    ...
    public static final void m1206setCursorOffsetULxng0E$foundation_release(long j, TextLayoutResultProxy textLayoutResultProxy, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> function1) {
        Companion.m1210setCursorOffsetULxng0E$foundation_release(j, textLayoutResultProxy, editProcessor, offsetMapping, function1);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m1207layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            ...
            return companion.m1209layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult2);
        }

        @JvmStatic
        /* renamed from: layout-_EkL_-Y$foundation_release  reason: not valid java name */
        public final Triple<Integer, Integer, TextLayoutResult> m1209layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            Intrinsics.checkNotNullParameter(textDelegate, "textDelegate");
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            TextLayoutResult layoutResult = textDelegate.m1201layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m6146getWidthimpl(layoutResult.m5447getSizeYbymL2g())), Integer.valueOf(IntSize.m6145getHeightimpl(layoutResult.m5447getSizeYbymL2g())), layoutResult);
        }
        ...
        public final void draw$foundation_release(Canvas canvas, TextFieldValue value, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint selectionPaint) {
            ...
            if (!TextRange.m5468getCollapsedimpl(value.m5695getSelectiond9O1mEE()) && (start = offsetMapping.originalToTransformed(TextRange.m5472getMinimpl(value.m5695getSelectiond9O1mEE()))) != (end = offsetMapping.originalToTransformed(TextRange.m5471getMaximpl(value.m5695getSelectiond9O1mEE())))) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            ...
            if (hasFocus) {
                int focusOffsetInTransformed = offsetMapping2.originalToTransformed(TextRange.m5471getMaximpl(value.m5695getSelectiond9O1mEE()));
                if (focusOffsetInTransformed < textLayoutResult.getLayoutInput().getText().length()) {
                    ...
                    bbox = new Rect(0.0f, 0.0f, 1.0f, (float) IntSize.m6145getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText$default(textDelegate.getStyle(), textDelegate.getDensity(), textDelegate.getFontFamilyResolver(), (String) null, 0, 24, (Object) null)));
                }
                long globalLT = layoutCoordinates2.m4841localToRootMKHz9U(OffsetKt.Offset(bbox.getLeft(), bbox.getTop()));
                textInputSession2.notifyFocusedRect(RectKt.m2955Recttz77jQw(OffsetKt.Offset(Offset.m2915getXimpl(globalLT), Offset.m2916getYimpl(globalLT)), SizeKt.Size(bbox.getWidth(), bbox.getHeight())));
            }
        }
        ...
        @JvmStatic
        /* renamed from: setCursorOffset-ULxng0E$foundation_release  reason: not valid java name */
        public final void m1210setCursorOffsetULxng0E$foundation_release(long position, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
            Intrinsics.checkNotNullParameter(editProcessor, "editProcessor");
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m5690copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1230getOffsetForPosition3MmeM6k$default(textLayoutResult, position, false, 2, (Object) null))), (TextRange) null, 5, (Object) null));
        }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            ...
            Intrinsics.checkNotNullParameter(editProcessor, "editProcessor");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m5690copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0, (TextRange) null, 3, (Object) null));
            textInputSession.dispose();
        }

        /* renamed from: applyCompositionDecoration-72CqOWE  reason: not valid java name */
        public final TransformedText m1208applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            ...
            SpanStyle spanStyle2 = new SpanStyle(0, 0, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0, TextDecoration.Companion.getUnderline(), (Shadow) null, 12287, (DefaultConstructorMarker) null);
            $this$applyCompositionDecoration_72CqOWE_u24lambda_u240.addStyle(spanStyle, transformed.getOffsetMapping().originalToTransformed(TextRange.m5474getStartimpl(compositionRange)), transformed.getOffsetMapping().originalToTransformed(TextRange.m5469getEndimpl(compositionRange)));

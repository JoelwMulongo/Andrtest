...
public final class TextFieldKeyInput_androidKt {
    ...
    public static final boolean m1215isTypedEventZmokQxo(KeyEvent $this$isTypedEvent) {
        Intrinsics.checkNotNullParameter($this$isTypedEvent, "$this$isTypedEvent");
        return $this$isTypedEvent.getAction() == 0 && $this$isTypedEvent.getUnicodeChar() != 0;
    }
}

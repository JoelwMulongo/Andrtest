...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.offset$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(initial), (SnapshotMutationPolicy) null, 2, (Object) null);
        ...
        this.previousSelection = TextRange.Companion.m5479getZerod9O1mEE();
    ...
    public final long m1219getPreviousSelectiond9O1mEE() {
        return this.previousSelection;
    }

    /* renamed from: setPreviousSelection-5zc-tL8  reason: not valid java name */
    public final void m1220setPreviousSelection5zctL8(long j) {
    ...
    public final int m1218getOffsetToFollow5zctL8(long selection) {
        if (TextRange.m5474getStartimpl(selection) != TextRange.m5474getStartimpl(this.previousSelection)) {
            return TextRange.m5474getStartimpl(selection);
        }
        if (TextRange.m5469getEndimpl(selection) != TextRange.m5469getEndimpl(this.previousSelection)) {
            return TextRange.m5469getEndimpl(selection);
        }
        return TextRange.m5472getMinimpl(selection);
    }

...
public final class TextFieldState {
    ...
    private final MutableState minHeightForSingleLineField$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5984boximpl(Dp.m5986constructorimpl((float) 0)), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final float m1224getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m6000unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4  reason: not valid java name */
    public final void m1225setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField$delegate.setValue(Dp.m5984boximpl(f));
    }
    ...
    public final void m1226updatefnh65Uc(AnnotatedString untransformedText2, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange2, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        this.selectionPaint.m3427setColor8_81llA(selectionBackgroundColor);
        ...
        this.untransformedText = annotatedString;
        TextDelegate newTextDelegate = CoreTextKt.m1142updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, (Object) null);

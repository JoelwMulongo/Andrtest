...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m1228canReuse7_7YC6M(TextLayoutResult $this$canReuse_u2d7_7YC6M, AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        ...
        if (!Intrinsics.areEqual((Object) layoutInput.getText(), (Object) annotatedString)) {
            ...
            int i4 = maxLines;
        } else if (layoutInput.getMaxLines() != maxLines || layoutInput.getSoftWrap() != z || !TextOverflow.m5891equalsimpl0(layoutInput.m5443getOverflowgIe3tQ8(), i) || !Intrinsics.areEqual((Object) layoutInput.getDensity(), (Object) density2) || layoutInput.getLayoutDirection() != layoutDirection2 || !Intrinsics.areEqual((Object) layoutInput.getFontFamilyResolver(), (Object) resolver) || Constraints.m5932getMinWidthimpl(constraints) != Constraints.m5932getMinWidthimpl(layoutInput.m5442getConstraintsmsEJaDk())) {
            return false;
        } else {
            if (!z && !TextOverflow.m5891equalsimpl0(i, TextOverflow.Companion.m5899getEllipsisgIe3tQ8())) {
                return true;
            }
            if (Constraints.m5930getMaxWidthimpl(constraints) == Constraints.m5930getMaxWidthimpl(layoutInput.m5442getConstraintsmsEJaDk()) && Constraints.m5929getMaxHeightimpl(constraints) == Constraints.m5929getMaxHeightimpl(layoutInput.m5442getConstraintsmsEJaDk())) {
                return true;
            }
            return false;
        }

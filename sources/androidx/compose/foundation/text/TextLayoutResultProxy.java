...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1230getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1232getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m1232getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long it = position;
        if (coerceInVisibleBounds) {
            it = m1229coercedInVisibleBoundsOfInputTextMKHz9U(it);
        }
        return this.value.m5446getOffsetForPositionk4lQ0M(m1231relativeToInputTextMKHz9U(it));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m2916getYimpl(m1231relativeToInputTextMKHz9U(m1229coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m1233isPositionOnTextk4lQ0M(long offset) {
        long relativeOffset = m1231relativeToInputTextMKHz9U(m1229coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int line = this.value.getLineForVerticalPosition(Offset.m2916getYimpl(relativeOffset));
        return Offset.m2915getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m2915getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }
    ...
    private final long m1231relativeToInputTextMKHz9U(long $this$relativeToInputText_u2dMK_u2dHz9U) {
        Offset offset;
        long j;
        ...
        if (innerTextFieldCoordinates2 != null) {
            ...
            if (decorationBoxCoordinates2 != null) {
                if (!innerTextFieldCoordinates2.isAttached() || !decorationBoxCoordinates2.isAttached()) {
                    ...
                    j = innerTextFieldCoordinates2.m4840localPositionOfR5De75A(decorationBoxCoordinates2, $this$relativeToInputText_u2dMK_u2dHz9U);
                }
                offset = Offset.m2904boximpl(j);
            } else {
                offset = null;
            }
            if (offset != null) {
                return offset.m2925unboximpl();
            }
        }
    ...
    private final long m1229coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L_0x0026:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1235coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1229coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}

...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long m1246calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m6104getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m6105getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m6104getXimpl(this.offset)) - IntSize.m6146getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m6105getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m6104getXimpl(this.offset)) - (IntSize.m6146getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m6105getYimpl(this.offset));
            default:

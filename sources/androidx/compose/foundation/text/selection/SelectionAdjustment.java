...
public interface SelectionAdjustment {
    ...
    long m1264adjustZXO7KMw(TextLayoutResult textLayoutResult, long j, int i, boolean z, TextRange textRange);
    ...
    public static final class Companion {
        ...
        public final long m1266adjustByBoundaryDvylE(TextLayoutResult textLayoutResult, long newRawSelection, Function1<? super Integer, TextRange> boundaryFun) {
            ...
            long startBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m5474getStartimpl(newRawSelection), 0, maxOffset))).m5478unboximpl();
            long endBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m5469getEndimpl(newRawSelection), 0, maxOffset))).m5478unboximpl();
            return TextRangeKt.TextRange(TextRange.m5473getReversedimpl(newRawSelection) ? TextRange.m5469getEndimpl(startBoundary) : TextRange.m5474getStartimpl(startBoundary), TextRange.m5473getReversedimpl(newRawSelection) ? TextRange.m5474getStartimpl(endBoundary) : TextRange.m5469getEndimpl(endBoundary));
        }

...
public final class SelectionHandlesKt {
    private static final float HandleHeight = Dp.m5986constructorimpl((float) 25);
    private static final float HandleWidth = Dp.m5986constructorimpl((float) 25);
    ...
    public static final long m1278getAdjustedCoordinatesk4lQ0M(long position) {
        return OffsetKt.Offset(Offset.m2915getXimpl(position), Offset.m2916getYimpl(position) - 1.0f);
    }
}

...
final class SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1 extends Lambda implements Function1<Offset, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m1279invokek4lQ0M(((Offset) p1).m2925unboximpl());
    }

    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
    public final AnimationVector2D m1279invokek4lQ0M(long it) {
        if (OffsetKt.m2934isSpecifiedk4lQ0M(it)) {
            return new AnimationVector2D(Offset.m2915getXimpl(it), Offset.m2916getYimpl(it));
        }

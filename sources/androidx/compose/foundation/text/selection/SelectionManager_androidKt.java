...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m1315isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().m1149mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }

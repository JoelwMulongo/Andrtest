...
public enum SelectionMode {
    ...
    public abstract int m1319compare3MmeM6k$foundation_release(long j, Rect rect);
    ...
    static final class Vertical extends SelectionMode {
        ...
        /* renamed from: compare-3MmeM6k$foundation_release  reason: not valid java name */
        public int m1322compare3MmeM6k$foundation_release(long position, Rect bounds) {
            Intrinsics.checkNotNullParameter(bounds, "bounds");
            if (bounds.m2941containsk4lQ0M(position)) {
                return 0;
            }
            if (Offset.m2916getYimpl(position) < bounds.getTop()) {
                return -1;
            }
            if (Offset.m2915getXimpl(position) >= bounds.getLeft() || Offset.m2916getYimpl(position) >= bounds.getBottom()) {
                return 1;
            }
            return -1;
        }
    ...
    static final class Horizontal extends SelectionMode {
        ...
        /* renamed from: compare-3MmeM6k$foundation_release  reason: not valid java name */
        public int m1321compare3MmeM6k$foundation_release(long position, Rect bounds) {
            Intrinsics.checkNotNullParameter(bounds, "bounds");
            if (bounds.m2941containsk4lQ0M(position)) {
                return 0;
            }
            if (Offset.m2915getXimpl(position) < bounds.getLeft()) {
                return -1;
            }
            if (Offset.m2916getYimpl(position) >= bounds.getTop() || Offset.m2915getXimpl(position) >= bounds.getRight()) {
                return 1;
            }
            return -1;
        }
    ...
    public final boolean m1320isSelected2x9bVx0$foundation_release(Rect bounds, long start, long end) {
        Intrinsics.checkNotNullParameter(bounds, "bounds");
        boolean z = true;
        if (bounds.m2941containsk4lQ0M(start) || bounds.m2941containsk4lQ0M(end)) {
            return true;
        }
        int compareStart = m1319compare3MmeM6k$foundation_release(start, bounds);
        int compareEnd = m1319compare3MmeM6k$foundation_release(end, bounds);

...
public final class TextSelectionColors {
    ...
    public final long m1358getHandleColor0d7_KjU() {
        return this.handleColor;
    }

    /* renamed from: getBackgroundColor-0d7_KjU  reason: not valid java name */
    public final long m1357getBackgroundColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextSelectionColors) && Color.m3165equalsimpl0(this.handleColor, ((TextSelectionColors) other).handleColor) && Color.m3165equalsimpl0(this.backgroundColor, ((TextSelectionColors) other).backgroundColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Color.m3171hashCodeimpl(this.handleColor) * 31) + Color.m3171hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m3172toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m3172toStringimpl(this.backgroundColor) + ')';
    }
}

...
final class AndroidAlertDialog_androidKt$AlertDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m761paddingVpY3zN4(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), Dp.m5986constructorimpl((float) 8), Dp.m5986constructorimpl((float) 2));
            ...
            MeasurePolicy measurePolicy$iv = BoxKt.rememberBoxMeasurePolicy(contentAlignment$iv, false, composer, ((6 >> 3) & 14) | ((6 >> 3) & 112));
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 350577093, "C80@3937L226:AndroidAlertDialog.android.kt#jmzs0o");
            int i5 = $changed$iv$iv$iv;
            AlertDialogKt.m1360AlertDialogFlowRowixp7dh8(Dp.m5986constructorimpl((float) 8), Dp.m5986constructorimpl((float) 12), ComposableLambdaKt.composableLambda($composer2, 1789213604, true, new AndroidAlertDialog_androidKt$AlertDialog$1$1$1(function2, i2, function22)), $composer2, 438);

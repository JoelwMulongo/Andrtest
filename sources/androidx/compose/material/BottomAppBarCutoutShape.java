...
final class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline m1386createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path boundingRectangle = AndroidPath_androidKt.Path();
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m2984getWidthimpl(size), Size.m2981getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.m3444opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.Companion.m3468getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        ...
        float cutoutOffset = density.m5967toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = (float) 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m2984getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m2981getHeightimpl(cutoutSize) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.m3518createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        path.m3446translatek4lQ0M(OffsetKt.Offset(cutoutStartX, -cutoutRadius));
        if (Intrinsics.areEqual((Object) this.cutoutShape, (Object) RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges($this$addCutoutShape, cutoutStartX, cutoutEndX, cutoutRadius, density.m5967toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }

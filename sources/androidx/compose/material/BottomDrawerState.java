...
public final class BottomDrawerState extends SwipeableState<BottomDrawerValue> {
    ...
    public BottomDrawerState(BottomDrawerValue initialValue, Function1<? super BottomDrawerValue, Boolean> confirmStateChange) {
        super(initialValue, DrawerKt.access$getAnimationSpec$p(), confirmStateChange);
    ...
    public final Object open(Continuation<? super Unit> $completion) {
        Object animateTo$default = SwipeableState.animateTo$default(this, isOpenEnabled() ? BottomDrawerValue.Open : BottomDrawerValue.Expanded, (AnimationSpec) null, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

    public final Object close(Continuation<? super Unit> $completion) {
        Object animateTo$default = SwipeableState.animateTo$default(this, BottomDrawerValue.Closed, (AnimationSpec) null, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

    public final Object expand(Continuation<? super Unit> $completion) {
        Object animateTo$default = SwipeableState.animateTo$default(this, BottomDrawerValue.Expanded, (AnimationSpec) null, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

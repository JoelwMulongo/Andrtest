...
final class BottomNavigationKt$BottomNavigationItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1396measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "icon")) {
                ...
                if (this.$label == null) {
                    ...
                    return BottomNavigationKt.m1394placeIcon3p2s80s(measureScope, iconPlaceable, j);
                }
                Intrinsics.checkNotNull(labelPlaceable);
                Placeable placeable3 = iconPlaceable;
                return BottomNavigationKt.m1395placeLabelAndIconDIyivk0($this$Layout, labelPlaceable, iconPlaceable, constraints, this.$iconPositionAnimationProgress);
            }
            j = constraints;
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");

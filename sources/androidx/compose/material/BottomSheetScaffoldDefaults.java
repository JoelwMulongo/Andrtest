...
public final class BottomSheetScaffoldDefaults {
    ...
    private static final float SheetElevation = Dp.m5986constructorimpl((float) 8);
    private static final float SheetPeekHeight = Dp.m5986constructorimpl((float) 56);

    private BottomSheetScaffoldDefaults() {
    }

    /* renamed from: getSheetElevation-D9Ej5fM  reason: not valid java name */
    public final float m1397getSheetElevationD9Ej5fM() {
        return SheetElevation;
    }

    /* renamed from: getSheetPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m1398getSheetPeekHeightD9Ej5fM() {

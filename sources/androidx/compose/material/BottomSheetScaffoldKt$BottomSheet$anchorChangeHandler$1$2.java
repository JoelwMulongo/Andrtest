...
final class BottomSheetScaffoldKt$BottomSheet$anchorChangeHandler$1$2 extends Lambda implements Function1<BottomSheetValue, Unit> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ BottomSheetState $state;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BottomSheetScaffoldKt$BottomSheet$anchorChangeHandler$1$2(CoroutineScope coroutineScope, BottomSheetState bottomSheetState) {
        super(1);
    ...
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.material.BottomSheetScaffoldKt$BottomSheet$anchorChangeHandler$1$2$1", f = "BottomSheetScaffold.kt", i = {}, l = {416}, m = "invokeSuspend", n = {}, s = {})
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (bottomSheetState.snapTo$material_release(target, this) != coroutine_suspended) {
                        break;
                    } else {

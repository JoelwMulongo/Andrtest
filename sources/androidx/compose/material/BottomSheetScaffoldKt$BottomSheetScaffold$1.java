    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            if (this.$drawerContent == null) {
                ...
                ComposerKt.sourceInformation(composer, "381@16230L7");
                this.$child.invoke(composer, 6);
                $composer.endReplaceableGroup();
            } else {
                composer.startReplaceableGroup(-249544774);
                ComposerKt.sourceInformation(composer, "383@16267L480");
                ...
                int i2 = this.$$dirty1;
                DrawerKt.m1488ModalDrawerGs3lGvM(function3, (Modifier) null, drawerState, z, shape, f, j, j2, j3, function2, $composer, ((i2 >> 9) & 14) | 805306368 | ((i2 >> 3) & 7168) | ((i2 >> 3) & 57344) | ((i2 >> 3) & 458752) | ((i2 >> 3) & 3670016) | ((i2 >> 3) & 29360128) | ((i2 >> 3) & 234881024), 2);
                $composer.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {

...
public final class BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1(SwipeableV2State<?> $state2, Orientation $orientation2) {
        this.$state = $state2;
        this.$orientation = $orientation2;
    }

    /* renamed from: onPreScroll-OzD1aCk  reason: not valid java name */
    public long m1409onPreScrollOzD1aCk(long available, int source) {
        float delta = offsetToFloat(available);
        if (delta >= 0.0f || !NestedScrollSource.m4561equalsimpl0(source, NestedScrollSource.Companion.m4566getDragWNlRxjI())) {
    ...
    public long m1407onPostScrollDzOQY0M(long consumed, long available, int source) {
    ...
    public java.lang.Object m1408onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r6 = this;
        ...
        L_0x0065:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.m1408onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.lang.Object m1406onPostFlingRZ2iAVY(long r5, long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            return r9
        L_0x0048:
            androidx.compose.ui.unit.Velocity r9 = androidx.compose.ui.unit.Velocity.m6202boximpl(r7)
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.m1406onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final float velocityToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Velocity.m6211getXimpl($this$toFloat) : Velocity.m6212getYimpl($this$toFloat);
    }

    private final float offsetToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Offset.m2915getXimpl($this$toFloat) : Offset.m2916getYimpl($this$toFloat);
    }
}

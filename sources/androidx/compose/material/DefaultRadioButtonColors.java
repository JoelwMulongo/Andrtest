...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3165equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m3165equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m3165equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Color.m3171hashCodeimpl(this.selectedColor) * 31) + Color.m3171hashCodeimpl(this.unselectedColor)) * 31) + Color.m3171hashCodeimpl(this.disabledColor);
    }
}

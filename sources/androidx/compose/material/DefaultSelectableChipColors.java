...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3165equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m3165equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m3165equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m3165equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m3165equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m3165equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m3165equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m3165equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m3165equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((Color.m3171hashCodeimpl(this.backgroundColor) * 31) + Color.m3171hashCodeimpl(this.contentColor)) * 31) + Color.m3171hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3171hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m3171hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3171hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3171hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m3171hashCodeimpl(this.selectedContentColor)) * 31) + Color.m3171hashCodeimpl(this.selectedLeadingIconColor);
    }
}

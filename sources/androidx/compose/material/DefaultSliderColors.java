...
final class DefaultSliderColors implements SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3165equalsimpl0(this.thumbColor, ((DefaultSliderColors) other).thumbColor) && Color.m3165equalsimpl0(this.disabledThumbColor, ((DefaultSliderColors) other).disabledThumbColor) && Color.m3165equalsimpl0(this.activeTrackColor, ((DefaultSliderColors) other).activeTrackColor) && Color.m3165equalsimpl0(this.inactiveTrackColor, ((DefaultSliderColors) other).inactiveTrackColor) && Color.m3165equalsimpl0(this.disabledActiveTrackColor, ((DefaultSliderColors) other).disabledActiveTrackColor) && Color.m3165equalsimpl0(this.disabledInactiveTrackColor, ((DefaultSliderColors) other).disabledInactiveTrackColor) && Color.m3165equalsimpl0(this.activeTickColor, ((DefaultSliderColors) other).activeTickColor) && Color.m3165equalsimpl0(this.inactiveTickColor, ((DefaultSliderColors) other).inactiveTickColor) && Color.m3165equalsimpl0(this.disabledActiveTickColor, ((DefaultSliderColors) other).disabledActiveTickColor) && Color.m3165equalsimpl0(this.disabledInactiveTickColor, ((DefaultSliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((Color.m3171hashCodeimpl(this.thumbColor) * 31) + Color.m3171hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3171hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3171hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3171hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3171hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3171hashCodeimpl(this.activeTickColor)) * 31) + Color.m3171hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3171hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3171hashCodeimpl(this.disabledInactiveTickColor);
    }
}

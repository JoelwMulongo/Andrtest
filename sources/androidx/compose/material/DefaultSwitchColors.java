...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3165equalsimpl0(this.checkedThumbColor, ((DefaultSwitchColors) other).checkedThumbColor) && Color.m3165equalsimpl0(this.checkedTrackColor, ((DefaultSwitchColors) other).checkedTrackColor) && Color.m3165equalsimpl0(this.uncheckedThumbColor, ((DefaultSwitchColors) other).uncheckedThumbColor) && Color.m3165equalsimpl0(this.uncheckedTrackColor, ((DefaultSwitchColors) other).uncheckedTrackColor) && Color.m3165equalsimpl0(this.disabledCheckedThumbColor, ((DefaultSwitchColors) other).disabledCheckedThumbColor) && Color.m3165equalsimpl0(this.disabledCheckedTrackColor, ((DefaultSwitchColors) other).disabledCheckedTrackColor) && Color.m3165equalsimpl0(this.disabledUncheckedThumbColor, ((DefaultSwitchColors) other).disabledUncheckedThumbColor) && Color.m3165equalsimpl0(this.disabledUncheckedTrackColor, ((DefaultSwitchColors) other).disabledUncheckedTrackColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m3171hashCodeimpl(this.checkedThumbColor) * 31) + Color.m3171hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m3171hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m3171hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m3171hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m3171hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m3171hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m3171hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}

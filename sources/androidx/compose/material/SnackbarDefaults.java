...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(Composer $composer, int $changed) {
        ...
        long r0 = ColorKt.m3209compositeOverOWjLjI(Color.m3163copywmQWz5c$default(MaterialTheme.INSTANCE.getColors($composer, 6).m1444getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors($composer, 6).m1449getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getPrimaryActionColor(Composer $composer, int $changed) {
        ...
        if (colors.isLight()) {
            primary = ColorKt.m3209compositeOverOWjLjI(Color.m3163copywmQWz5c$default(colors.m1449getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, (Object) null), colors.m1445getPrimary0d7_KjU());
        } else {
            primary = colors.m1446getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }

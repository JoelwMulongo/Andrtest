...
public final class Strings {
    ...
    public static final int CloseDrawer = m1605constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int CloseSheet = m1605constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int DefaultErrorMessage = m1605constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int ExposedDropdownMenu = m1605constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int NavigationMenu = m1605constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int SliderRangeEnd = m1605constructorimpl(6);
    /* access modifiers changed from: private */
    public static final int SliderRangeStart = m1605constructorimpl(5);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Strings m1604boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1605constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1606equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).m1610unboximpl();
    }

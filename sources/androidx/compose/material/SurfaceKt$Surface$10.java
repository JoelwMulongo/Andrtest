...
final class SurfaceKt$Surface$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C463@23169L7,461@23040L221,472@23518L16,456@22853L879:Surface.kt#jmzs0o");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-311657392, i, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:455)");
            }
            ...
            Shape shape2 = shape;
            Modifier modifier$iv = ToggleableKt.m1084toggleableO2vRcR0$default(SurfaceKt.m1626surface8ww4TTg(modifier, shape2, SurfaceKt.m1627surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) consume, this.$absoluteElevation, $composer, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$checked, this.$interactionSource, RippleKt.m1729rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (Role) null, this.$onCheckedChange, 16, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1505987388, "C478@23713L9:Surface.kt#jmzs0o");

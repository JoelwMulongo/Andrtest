...
final class SurfaceKt$Surface$13 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C595@29868L7,593@29739L221,588@29563L973:Surface.kt#jmzs0o");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SurfaceKt.m1626surface8ww4TTg(minimumInteractiveComponentSize, shape, SurfaceKt.m1627surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) consume, this.$absoluteElevation, $composer, (this.$$dirty >> 9) & 14), this.$border, this.$elevation).then(ClickableKt.m470clickableO2vRcR0(Modifier.Companion, this.$interactionSource, this.$indication, this.$enabled, this.$onClickLabel, this.$role, this.$onClick));
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1505994192, "C613@30517L9:Surface.kt#jmzs0o");

...
final class SurfaceKt$Surface$7 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C348@17299L7,346@17170L221,357@17652L16,341@16983L869:Surface.kt#jmzs0o");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1391199439, i, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:340)");
            }
            ...
            Shape shape2 = shape;
            Modifier modifier$iv = SelectableKt.m1080selectableO2vRcR0$default(SurfaceKt.m1626surface8ww4TTg(modifier, shape2, SurfaceKt.m1627surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) consume, this.$absoluteElevation, $composer, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$selected, this.$interactionSource, RippleKt.m1729rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1505981508, "C363@17833L9:Surface.kt#jmzs0o");

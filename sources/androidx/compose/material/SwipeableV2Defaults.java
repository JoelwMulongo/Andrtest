...
public final class SwipeableV2Defaults {
    ...
    private static final Function2<Density, Float, Float> PositionalThreshold = SwipeableV2Kt.m1640fixedPositionalThreshold0680j_4(Dp.m5986constructorimpl((float) 56));
    private static final float VelocityThreshold = Dp.m5986constructorimpl((float) 125);
    ...
    public static /* synthetic */ void m1638getVelocityThresholdD9Ej5fM$annotations() {
    }
    ...
    public final float m1639getVelocityThresholdD9Ej5fM() {
    ...
    public final <T> AnchorChangeHandler<T> ReconcileAnimationOnAnchorChangeHandler$material_release(SwipeableV2State<T> state, Function2<? super T, ? super Float, Unit> animate, Function1<? super T, Unit> snap) {

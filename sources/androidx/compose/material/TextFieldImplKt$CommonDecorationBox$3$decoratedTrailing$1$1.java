    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1894727196, $changed, -1, "androidx.compose.material.CommonDecorationBox.<anonymous>.<anonymous>.<anonymous> (TextFieldImpl.kt:169)");
            }
            TextFieldImplKt.m1683DecorationeuL9pac(this.$trailingIconColor, (TextStyle) null, (Float) null, this.$it, $composer, 0, 6);
            if (ComposerKt.isTraceInProgress()) {

...
public final class ThumbUpKt {
    ...
    public static final ImageVector getThumbUp(Icons.Filled $this$ThumbUp) {
        ...
        ImageVector build = ImageVector.Builder.m3873addPathoIyEayM$default(new ImageVector.Builder("Filled.ThumbUp", Dp.m5986constructorimpl(24.0f), Dp.m5986constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null), nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3190getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _thumbUp = build;

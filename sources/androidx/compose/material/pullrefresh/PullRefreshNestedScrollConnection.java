...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long m1715onPreScrollOzD1aCk(long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m2931getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m4561equalsimpl0(source, NestedScrollSource.Companion.m4566getDragWNlRxjI()) || Offset.m2916getYimpl(available) >= 0.0f) {
            return Offset.Companion.m2931getZeroF1C5BW0();
        }
        return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m2916getYimpl(available))).floatValue());
    }

    /* renamed from: onPostScroll-DzOQY0M  reason: not valid java name */
    public long m1713onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m2931getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m4561equalsimpl0(source, NestedScrollSource.Companion.m4566getDragWNlRxjI()) || Offset.m2916getYimpl(available) <= 0.0f) {
    ...
    public java.lang.Object m1714onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L_0x0035:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m6212getYimpl(r8)
        ...
        L_0x0050:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m6202boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.m1714onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}

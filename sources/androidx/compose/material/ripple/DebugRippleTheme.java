...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long m1719defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long r0 = RippleTheme.Companion.m1732defaultRippleColor5vOe2sY(Color.Companion.m3190getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha r0 = RippleTheme.Companion.m1731defaultRippleAlphaDxMtmZc(Color.Companion.m3190getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

...
public final class RippleAnimation {
    ...
    public final void m1722draw4WTKRHQ(DrawScope $this$draw_u2d4WTKRHQ, long color) {
        float f;
        Float f2;
        DrawScope drawScope = $this$draw_u2d4WTKRHQ;
        Intrinsics.checkNotNullParameter(drawScope, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1724getRippleStartRadiusuvyYCjk($this$draw_u2d4WTKRHQ.m3772getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                f2 = Float.valueOf(RippleAnimationKt.m1723getRippleEndRadiuscSwnlzA(drawScope, this.bounded, $this$draw_u2d4WTKRHQ.m3772getSizeNHjbRc()));
            } else {
                f2 = Float.valueOf(drawScope.m5967toPx0680j_4(this.radius));
            }
            this.targetRadius = f2;
        }
        if (this.origin == null) {
            this.origin = Offset.m2904boximpl($this$draw_u2d4WTKRHQ.m3771getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m2904boximpl(OffsetKt.Offset(Size.m2984getWidthimpl($this$draw_u2d4WTKRHQ.m3772getSizeNHjbRc()) / 2.0f, Size.m2981getHeightimpl($this$draw_u2d4WTKRHQ.m3772getSizeNHjbRc()) / 2.0f));
        }
        ...
        float r1 = Offset.m2915getXimpl(offset.m2925unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp = MathHelpersKt.lerp(r1, Offset.m2915getXimpl(offset2.m2925unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float r2 = Offset.m2916getYimpl(offset3.m2925unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(lerp, MathHelpersKt.lerp(r2, Offset.m2916getYimpl(offset4.m2925unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long modulatedColor = Color.m3163copywmQWz5c$default(color, Color.m3166getAlphaimpl(color) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (this.bounded) {
            DrawScope $this$clipRect_u2drOu3jXo_u24default$iv = $this$draw_u2d4WTKRHQ;
            float right$iv = Size.m2984getWidthimpl($this$clipRect_u2drOu3jXo_u24default$iv.m3772getSizeNHjbRc());
            ...
            DrawContext $this$withTransform_u24lambda_u2d6$iv$iv = $this$withTransform$iv$iv.getDrawContext();
            long previousSize$iv$iv = $this$withTransform_u24lambda_u2d6$iv$iv.m3715getSizeNHjbRc();
            $this$withTransform_u24lambda_u2d6$iv$iv.getCanvas().save();
            DrawScope drawScope2 = $this$clipRect_u2drOu3jXo_u24default$iv;
            $this$withTransform_u24lambda_u2d6$iv$iv.getTransform().m3827clipRectN_I0leg(0.0f, 0.0f, right$iv, bottom$iv, clipOp$iv);
            DrawContext $this$withTransform_u24lambda_u2d6$iv$iv2 = $this$withTransform_u24lambda_u2d6$iv$iv;
            DrawScope.m3735drawCircleVaOC9Bg$default($this$withTransform$iv$iv, modulatedColor, radius2, centerOffset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
            $this$withTransform_u24lambda_u2d6$iv$iv2.getCanvas().restore();
            $this$withTransform_u24lambda_u2d6$iv$iv2.m3716setSizeuvyYCjk(previousSize$iv$iv);
            return;
        }
        DrawScope.m3735drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius2, centerOffset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
    }
}

...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5986constructorimpl((float) 10);
    ...
    public static final float m1724getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m2984getWidthimpl(size), Size.m2981getHeightimpl(size)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1723getRippleEndRadiuscSwnlzA(Density $this$getRippleEndRadius_u2dcSwnlzA, boolean bounded, long size) {
        Intrinsics.checkNotNullParameter($this$getRippleEndRadius_u2dcSwnlzA, "$this$getRippleEndRadius");
        float radiusCoveringBounds = Offset.m2913getDistanceimpl(OffsetKt.Offset(Size.m2984getWidthimpl(size), Size.m2981getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return $this$getRippleEndRadius_u2dcSwnlzA.m5967toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }

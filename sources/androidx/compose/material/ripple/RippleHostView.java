...
public final class RippleHostView extends View {
    ...
    public final void m1726addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded2, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple2) {
        boolean z = bounded2;
        ...
        m1727updateRipplePropertiesbiQXAtU(size, radius, color, alpha);
        if (z) {
            ripple2.setHotspot(Offset.m2915getXimpl(interaction.m650getPressPositionF1C5BW0()), Offset.m2916getYimpl(interaction.m650getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1727updateRipplePropertiesbiQXAtU(long size, int radius, long color, float alpha) {
        UnprojectedRipple ripple2 = this.ripple;
        if (ripple2 != null) {
            ripple2.trySetRadius(radius);
            ripple2.m1735setColorDxMtmZc(color, alpha);
            Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m2984getWidthimpl(size)), MathKt.roundToInt(Size.m2981getHeightimpl(size)));

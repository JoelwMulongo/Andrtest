...
public interface RippleTheme {
    ...
    long m1730defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1732defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m3216luminance8_81llA(contentColor);
            if (lightTheme || ((double) contentLuminance) >= 0.5d) {
                return contentColor;
            }
            return Color.Companion.m3201getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1731defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (!lightTheme) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m3216luminance8_81llA(contentColor)) > 0.5d) {

...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1735setColorDxMtmZc(long color, float alpha) {
        long newColor = m1734calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m3165equalsimpl0(color2.m3174unboximpl(), newColor))) {
            this.rippleColor = Color.m3154boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m3218toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1734calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m3163copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }

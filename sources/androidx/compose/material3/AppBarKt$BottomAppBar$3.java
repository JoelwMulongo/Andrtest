...
final class AppBarKt$BottomAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C471@23579L365:AppBar.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-396569832, i, -1, "androidx.compose.material3.BottomAppBar.<anonymous> (AppBar.kt:470)");
            }
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m816height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m2274getContainerHeightD9Ej5fM()), this.$contentPadding);

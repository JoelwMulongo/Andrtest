...
final class AppBarKt$TwoRowsTopAppBar$actionsRow$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C1131@51052L157:AppBar.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1048401111, i, -1, "androidx.compose.material3.TwoRowsTopAppBar.<anonymous> (AppBar.kt:1130)");
            }

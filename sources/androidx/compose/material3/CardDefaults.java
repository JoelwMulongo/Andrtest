...
public final class CardDefaults {
    ...
    public final CardElevation m1775cardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilledCardTokens.INSTANCE.m2449getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = FilledCardTokens.INSTANCE.m2455getPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = FilledCardTokens.INSTANCE.m2452getFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = FilledCardTokens.INSTANCE.m2453getHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            draggedElevation2 = FilledCardTokens.INSTANCE.m2451getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = FilledCardTokens.INSTANCE.m2450getDisabledContainerElevationD9Ej5fM();
        } else {
    ...
    public final CardElevation m1777elevatedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? ElevatedCardTokens.INSTANCE.m2365getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = ElevatedCardTokens.INSTANCE.m2371getPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = ElevatedCardTokens.INSTANCE.m2368getFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = ElevatedCardTokens.INSTANCE.m2369getHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            draggedElevation2 = ElevatedCardTokens.INSTANCE.m2367getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = ElevatedCardTokens.INSTANCE.m2366getDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m1779outlinedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? OutlinedCardTokens.INSTANCE.m2549getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            draggedElevation2 = OutlinedCardTokens.INSTANCE.m2551getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = OutlinedCardTokens.INSTANCE.m2550getDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m1774cardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = ColorKt.m3209compositeOverOWjLjI(Color.m3163copywmQWz5c$default(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m1859surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), FilledCardTokens.INSTANCE.m2450getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m3163copywmQWz5c$default(ColorSchemeKt.m1854contentColorForek8zF_U(containerColor2, composer, i2 & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final CardColors m1776elevatedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = ColorKt.m3209compositeOverOWjLjI(Color.m3163copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m1859surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), ElevatedCardTokens.INSTANCE.m2366getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
    ...
    public final CardColors m1778outlinedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
    ...
    public final BorderStroke outlinedCardBorder(boolean enabled, Composer $composer, int $changed, int i) {
        ...
        if (enabled) {
            ...
            color = ColorKt.m3209compositeOverOWjLjI(Color.m3163copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), $composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m1859surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), OutlinedCardTokens.INSTANCE.m2550getDisabledContainerElevationD9Ej5fM()));
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = BorderStrokeKt.m468BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m2555getOutlineWidthD9Ej5fM(), color);

...
public final class FabPosition {
    ...
    public static final int Center = m1923constructorimpl(0);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int End = m1923constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FabPosition m1922boximpl(int i) {
    ...
    public static boolean m1924equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).m1928unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1924equalsimpl(this.value, obj);
    }
    ...
    public static final class Companion {
        ...
        public final int m1929getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs  reason: not valid java name */
        public final int m1930getEndERTFSPs() {
    ...
    public String toString() {
        return m1927toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1927toStringimpl(int arg0) {
        if (m1925equalsimpl0(arg0, Center)) {
            return "FabPosition.Center";
        }
        return "FabPosition.End";
    }

...
final class IconButtonKt$FilledIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C333@16075L152:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1235871670, i, -1, "androidx.compose.material3.FilledIconToggleButton.<anonymous> (IconButton.kt:332)");
            }
            Modifier modifier$iv = SizeKt.m830size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m2456getContainerSizeD9Ej5fM());

...
final class IconButtonKt$FilledTonalIconButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconButton$2(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C274@13182L157:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1772884636, i, -1, "androidx.compose.material3.FilledTonalIconButton.<anonymous> (IconButton.kt:273)");
            }
            Modifier modifier$iv = SizeKt.m830size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m2472getContainerSizeD9Ej5fM());

...
final class IconButtonKt$OutlinedIconButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$OutlinedIconButton$2(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C463@22524L154:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m830size3ABfNKs(Modifier.Companion, OutlinedIconButtonTokens.INSTANCE.m2557getContainerSizeD9Ej5fM());
            ...
            if (($changed$iv & 11) != 2 || !$composer$iv.getSkipping()) {
                ...
                $composer2.startReplaceableGroup(-1497510528);
                ComposerKt.sourceInformation($composer2, "C467@22663L9:IconButton.kt#uh7d8r");
                int i4 = $changed2;

...
final class IconButtonKt$OutlinedIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C526@25714L154:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1207657396, i, -1, "androidx.compose.material3.OutlinedIconToggleButton.<anonymous> (IconButton.kt:525)");
            }

...
final class ListItemKt$ListItem$3 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    ListItemKt$ListItem$3(Function2<? super Composer, ? super Integer, Unit> function2, ListItemColors listItemColors, int i, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24) {
        super(3);
    ...
    public final void invoke(RowScope $this$ListItem, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation(composer, "C181@7659L638,202@8471L33,200@8357L209,200@8357L211:ListItem.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1733969726, $dirty2, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:173)");
            }
            composer.startReplaceableGroup(1316675520);
            ComposerKt.sourceInformation(composer, "177@7536L32,175@7425L205,175@7425L207");
            ...
            if (($changed$iv & 11) != 2 || !$composer$iv3.getSkipping()) {
                ...
                if (($changed2 & 81) != 16 || !$composer3.getSkipping()) {
                    ...
                    if (($changed$iv2 & 11) != 2 || !$composer$iv5.getSkipping()) {
                        ...
                        $composer4.startReplaceableGroup(562295746);
                        ComposerKt.sourceInformation($composer4, "C188@7895L15,187@7837L196,193@8112L29,192@8054L211:ListItem.kt#uh7d8r");
                        int i5 = (((0 >> 6) & 112) | 6) & 81;
                        ...
                        if (i5 != 16 || !$composer4.getSkipping()) {
                            ...
                            ListItemKt.m1973ProvideTextStyleFromToken3JVO9M(listItemColors.overlineColor$material3_release($composer4, (i >> 18) & 14).getValue().m3174unboximpl(), ListTokens.INSTANCE.getListItemOverlineFont(), function22, $composer5, (i & 896) | 48);
                            $composer2 = $composer5;

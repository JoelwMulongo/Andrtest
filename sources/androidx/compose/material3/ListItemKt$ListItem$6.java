...
final class ListItemKt$ListItem$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ListItemKt$ListItem$6(float f, PaddingValues paddingValues, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
        this.$minHeight = f;
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C299@12018L152:ListItem.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1393735016, i, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:298)");
            }
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m818heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, (Object) null), this.$paddingValues);

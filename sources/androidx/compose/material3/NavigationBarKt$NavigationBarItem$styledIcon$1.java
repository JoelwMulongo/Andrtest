...
final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    NavigationBarKt$NavigationBarItem$styledIcon$1(NavigationBarItemColors navigationBarItemColors, boolean z, int i, Function2<? super Composer, ? super Integer, Unit> function2, boolean z2, Function2<? super Composer, ? super Integer, Unit> function22) {
        super(2);
    ...
    private static final long m2002invoke$lambda0(State<Color> $iconColor$delegate) {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C171@7899L30,174@8099L185:NavigationBar.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            if ((($changed$iv$iv$iv >> 9) & 14 & 11) != 2 || !$composer$iv.getSkipping()) {
                ...
                ComposerKt.sourceInformation($composer2, "C175@8196L78:NavigationBar.kt#uh7d8r");
                int i4 = $changed2;
                if (($changed2 & 81) != 16 || !$composer2.getSkipping()) {
                    State<Color> state = iconColor$material3_release;
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3154boximpl(m2002invoke$lambda0(iconColor$material3_release)))}, (Function2<? super Composer, ? super Integer, Unit>) function2, $composer2, ((i3 >> 6) & 112) | 8);
                } else {

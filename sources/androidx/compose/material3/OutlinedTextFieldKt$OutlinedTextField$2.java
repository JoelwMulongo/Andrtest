...
final class OutlinedTextFieldKt$OutlinedTextField$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C181@9663L20,162@8848L2229:OutlinedTextField.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1801753362, i, -1, "androidx.compose.material3.OutlinedTextField.<anonymous> (OutlinedTextField.kt:160)");
            }
            if (this.$label != null) {
            ...
            BasicTextFieldKt.BasicTextField(str5, (Function1) function13, modifier3, z14, z15, textStyle3, keyboardOptions3, keyboardActions3, z16, i13, visualTransformation5, (Function1) null, mutableInteractionSource5, brush, (Function3) ComposableLambdaKt.composableLambda($composer, 794931831, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
                    ...
                    ComposerKt.sourceInformation(composer, "C189@10058L995:OutlinedTextField.kt#uh7d8r");
                    int $dirty = $changed;
                    if (($changed & 14) == 0) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(794931831, $dirty2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:188)");
                        }
                        ...
                        int i3 = i6;
                        int i4 = i7;
                        int i5 = (i3 & 14) | (($dirty2 << 3) & 112) | ((i3 >> 3) & 896) | ((i4 >> 6) & 7168) | ((i4 << 6) & 57344) | (458752 & (i4 >> 6)) | ((i4 << 15) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192);
                        int i6 = ((i3 >> 27) & 14) | 221184 | ((i4 << 3) & 112) | ((i4 >> 21) & 896);
                        textFieldDefaults2.OutlinedTextFieldDecorationBox(str2, innerTextField, z6, z7, visualTransformation2, interactionSource, z3, function26, function27, function28, function29, function210, textFieldColors3, (PaddingValues) null, ComposableLambdaKt.composableLambda(composer2, -839984881, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                invoke((Composer) p1, ((Number) p2).intValue());
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                int i = $changed;
                                ComposerKt.sourceInformation($composer, "C204@10769L244:OutlinedTextField.kt#uh7d8r");
                                if ((i & 11) != 2 || !$composer.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-839984881, i, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous>.<anonymous> (OutlinedTextField.kt:203)");
                                    }

...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition $this$calculateTabOffset, Density density, int edgeOffset, List<TabPosition> tabPositions) {
        ...
        int totalTabRowWidth = $this$calculateTabOffset_u24lambda_u2d1.m5961roundToPx0680j_4(((TabPosition) CollectionsKt.last(tabPositions)).m2129getRightD9Ej5fM()) + edgeOffset;
        int visibleWidth = totalTabRowWidth - this.scrollState.getMaxValue();
        return RangesKt.coerceIn($this$calculateTabOffset_u24lambda_u2d1.m5961roundToPx0680j_4($this$calculateTabOffset.m2128getLeftD9Ej5fM()) - ((visibleWidth / 2) - ($this$calculateTabOffset_u24lambda_u2d1.m5961roundToPx0680j_4($this$calculateTabOffset.m2130getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(totalTabRowWidth - visibleWidth, 0));
    }
}

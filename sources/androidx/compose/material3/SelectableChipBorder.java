...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m468BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipBorder) || !Color.m3165equalsimpl0(this.borderColor, ((SelectableChipBorder) other).borderColor) || !Color.m3165equalsimpl0(this.selectedBorderColor, ((SelectableChipBorder) other).selectedBorderColor) || !Color.m3165equalsimpl0(this.disabledBorderColor, ((SelectableChipBorder) other).disabledBorderColor) || !Color.m3165equalsimpl0(this.disabledSelectedBorderColor, ((SelectableChipBorder) other).disabledSelectedBorderColor) || !Dp.m5991equalsimpl0(this.borderWidth, ((SelectableChipBorder) other).borderWidth) || !Dp.m5991equalsimpl0(this.selectedBorderWidth, ((SelectableChipBorder) other).selectedBorderWidth)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m3171hashCodeimpl(this.borderColor) * 31) + Color.m3171hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m3171hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3171hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5992hashCodeimpl(this.borderWidth)) * 31) + Dp.m5992hashCodeimpl(this.selectedBorderWidth);
    }
}

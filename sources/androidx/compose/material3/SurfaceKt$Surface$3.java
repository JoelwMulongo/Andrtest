...
final class SurfaceKt$Surface$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C223@11164L139,232@11534L16,218@10986L788:Surface.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1279702876, i, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:217)");
            }
            Modifier modifier$iv = ClickableKt.m471clickableO2vRcR0$default(SurfaceKt.m2103surface8ww4TTg(TouchTargetKt.minimumTouchTargetSize(this.$modifier), this.$shape, SurfaceKt.m2104surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 12) & 14), this.$border, this.$shadowElevation), this.$interactionSource, RippleKt.m1729rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (String) null, Role.m5306boximpl(Role.Companion.m5313getButtono7Vup1c()), this.$onClick, 8, (Object) null);

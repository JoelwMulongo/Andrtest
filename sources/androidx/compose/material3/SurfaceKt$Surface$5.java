...
final class SurfaceKt$Surface$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C335@16812L139,345@17224L16,330@16634L827:Surface.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1164547968, i, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:329)");
            }
            Modifier modifier$iv = SelectableKt.m1079selectableO2vRcR0(SurfaceKt.m2103surface8ww4TTg(TouchTargetKt.minimumTouchTargetSize(this.$modifier), this.$shape, SurfaceKt.m2104surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14), this.$border, this.$shadowElevation), this.$selected, this.$interactionSource, RippleKt.m1729rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, Role.m5306boximpl(Role.Companion.m5319getTabo7Vup1c()), this.$onClick);

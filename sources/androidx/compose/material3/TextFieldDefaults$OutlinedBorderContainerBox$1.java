...
final class TextFieldDefaults$OutlinedBorderContainerBox$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        this.$tmp0_rcvr.m2148OutlinedBorderContainerBoxnbWgWpA(this.$enabled, this.$isError, this.$interactionSource, this.$colors, this.$shape, this.$focusedBorderThickness, this.$unfocusedBorderThickness, composer, this.$$changed | 1, this.$$default);
    }
}

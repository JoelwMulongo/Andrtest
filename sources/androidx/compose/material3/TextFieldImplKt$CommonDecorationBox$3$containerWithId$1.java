...
final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C171@7210L151:TextFieldImpl.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1566950173, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:170)");
            }
            ...
            if (($changed$iv & 11) != 2 || !$composer$iv.getSkipping()) {
                ...
                $composer2.startReplaceableGroup(1634460887);
                ComposerKt.sourceInformation($composer2, "C173@7328L11:TextFieldImpl.kt#uh7d8r");
                int i4 = $changed2;

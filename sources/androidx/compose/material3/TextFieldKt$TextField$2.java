...
final class TextFieldKt$TextField$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C198@10029L20,187@9591L1628:TextField.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1197699922, i, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:185)");
            }
            ...
            Brush brush2 = brush;
            BasicTextFieldKt.BasicTextField(str5, (Function1) function13, modifier2, z14, z15, textStyle3, keyboardOptions3, keyboardActions3, z16, i12, visualTransformation5, (Function1) null, mutableInteractionSource5, brush2, (Function3) ComposableLambdaKt.composableLambda($composer, 172557367, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
                    ...
                    ComposerKt.sourceInformation(composer, "C207@10517L678:TextField.kt#uh7d8r");
                    int $dirty = $changed;
                    if (($changed & 14) == 0) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(172557367, $dirty2, -1, "androidx.compose.material3.TextField.<anonymous>.<anonymous> (TextField.kt:205)");
                        }
                        ...
                        String str2 = str;
                        int i2 = i6;
                        int i3 = ((i2 >> 6) & 7168) | (i & 14) | (($dirty3 << 3) & 112) | ((i >> 3) & 896) | ((i2 << 6) & 57344) | ((i2 >> 6) & 458752) | ((i2 << 15) & 3670016) | ((i << 3) & 29360128) | ((i << 3) & 234881024) | ((i << 3) & 1879048192);
                        int i4 = ((i >> 27) & 14) | 1572864 | ((i2 << 3) & 112) | ((i2 >> 18) & 896) | ((i2 >> 18) & 7168);
                        textFieldDefaults.TextFieldDecorationBox(str2, innerTextField, z11, z12, visualTransformation4, mutableInteractionSource4, z, function22, function23, function24, function25, function26, shape, textFieldColors, (PaddingValues) null, (Function2<? super Composer, ? super Integer, Unit>) null, $composer, i3, i4, 49152);
                        if (ComposerKt.isTraceInProgress()) {

...
public final class TouchTargetKt$minimumTouchTargetSize$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$minimumTouchTargetSize_u24lambda_u2d0 = $this$null;
        $this$minimumTouchTargetSize_u24lambda_u2d0.setName("minimumTouchTargetSize");
        $this$minimumTouchTargetSize_u24lambda_u2d0.getProperties().set("README", "Adds outer padding to measure at least 48.dp (default) in size to disambiguate touch interactions if the element would measure smaller");
    }
}

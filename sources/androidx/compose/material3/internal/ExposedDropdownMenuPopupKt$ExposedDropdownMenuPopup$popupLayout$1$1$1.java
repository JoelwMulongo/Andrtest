...
final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C100@4002L533:ExposedDropdownMenuPopup.kt#mqatfk");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                    m2256invokeozmzZPI(((IntSize) p1).m6150unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                public final void m2256invokeozmzZPI(long it) {
                    popupLayout.m2259setPopupContentSizefhxjrPA(IntSize.m6138boximpl(it));
            ...
            Function2 content$iv = ComposableLambdaKt.composableLambda(composer, 588819933, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ComposerKt.sourceInformation($composer, "C111@4501L16:ExposedDropdownMenuPopup.kt#mqatfk");
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(588819933, $changed, -1, "androidx.compose.material3.internal.ExposedDropdownMenuPopup.<anonymous>.<anonymous>.<anonymous>.<anonymous> (ExposedDropdownMenuPopup.kt:110)");
                        }
                        ExposedDropdownMenuPopupKt.m2253ExposedDropdownMenuPopup$lambda0(state).invoke($composer, 0);
                        if (ComposerKt.isTraceInProgress()) {

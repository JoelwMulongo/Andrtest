...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5986constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5986constructorimpl((float) 4.0d);
    ...
    public final float m2501getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2502getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }

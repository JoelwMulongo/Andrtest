...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5986constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5986constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m5986constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2373getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2372getLevel0D9Ej5fM();
    ...
    public final float m2523getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2524getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2525getContainerWidthD9Ej5fM() {
    ...
    public final float m2527getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2528getStandardContainerElevationD9Ej5fM() {

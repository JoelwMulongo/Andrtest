...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5986constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5986constructorimpl((float) 24.0d);
    ...
    public final float m2557getContainerSizeD9Ej5fM() {
    ...
    public final float m2558getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2559getUnselectedOutlineWidthD9Ej5fM() {

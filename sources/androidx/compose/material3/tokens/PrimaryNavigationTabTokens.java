...
public final class PrimaryNavigationTabTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5986constructorimpl((float) 3.0d);
    private static final RoundedCornerShape ActiveIndicatorShape = RoundedCornerShapeKt.m1118RoundedCornerShape0680j_4(Dp.m5986constructorimpl((float) 3.0d));
    ...
    private static final float ContainerHeight = Dp.m5986constructorimpl((float) 48.0d);
    ...
    private static final float DividerHeight = Dp.m5986constructorimpl((float) 1.0d);
    public static final PrimaryNavigationTabTokens INSTANCE = new PrimaryNavigationTabTokens();
    private static final float IconAndLabelTextContainerHeight = Dp.m5986constructorimpl((float) 64.0d);
    ...
    public final float m2647getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2650getDividerHeightD9Ej5fM() {
    ...
    public final float m2651getIconAndLabelTextContainerHeightD9Ej5fM() {
        return IconAndLabelTextContainerHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m2652getIconSizeD9Ej5fM() {
        return IconSize;
    }

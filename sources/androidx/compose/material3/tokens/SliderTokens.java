...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m5986constructorimpl((float) 4.0d);
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2372getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2373getLevel1D9Ej5fM();
    private static final float HandleHeight = Dp.m5986constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m5986constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m5986constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2372getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5986constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m5986constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5986constructorimpl((float) 2.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2372getLevel0D9Ej5fM();
    ...
    public final float m2655getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2656getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2657getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2658getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2659getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2660getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2661getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2662getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2664getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m2666getTrackElevationD9Ej5fM() {
    ...
    public final float m2663getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2665getTickMarksContainerSizeD9Ej5fM() {

...
final class GroupKind {
    ...
    public static final int Group = m2767constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Node = m2767constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int ReusableNode = m2767constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ GroupKind m2766boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2767constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2768equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m2774unboximpl();
    }
    ...
    public static final boolean m2771isNodeimpl(int arg0) {
        return arg0 != Companion.m2775getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl  reason: not valid java name */
    public static final boolean m2772isReusableimpl(int arg0) {
        return arg0 != Companion.m2776getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m2775getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs  reason: not valid java name */
        public final int m2776getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs  reason: not valid java name */
        public final int m2777getReusableNodeULZAiWs() {

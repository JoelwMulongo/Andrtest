...
public final class RecomposeScopeImpl implements ScopeUpdateScope, RecomposeScope {
    ...
    public RecomposeScopeImpl(CompositionImpl composition2) {
    ...
    public final void adoptedBy(CompositionImpl composition2) {
    ...
    public final void recordRead(Object instance) {
        ...
        if (!getRereading()) {
            ...
            if (instance instanceof DerivedState) {
                ...
                tracked.set(instance, ((DerivedState) instance).getCurrentValue());
            }
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x005a A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public final void rereadTrackedInstances() {
        ...
        CompositionImpl composition2 = this.composition;
        if (composition2 != null && (trackedInstances2 = this.trackedInstances) != null) {
            setRereading(true);
            ...
            try {
                ...
                for (int i$iv = 0; i$iv < size; i$iv++) {
                    ...
                    composition2.recordReadOf(value);
                }
            } finally {
                setRereading(false);
            }
    ...
    public final Function1<Composition, Unit> end(int token) {
        ...
        while (true) {
            ...
            Intrinsics.checkNotNull(this_$iv.getKeys()[i$iv], "null cannot be cast to non-null type kotlin.Any");
            if (this_$iv.getValues()[i$iv] != token) {
                z = true;
            }
            if (z) {
                z = true;

...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m2778boximpl(Composer composer2) {
        return new SkippableUpdater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2779constructorimpl(Composer composer2) {
        Intrinsics.checkNotNullParameter(composer2, "composer");
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2780equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual((Object) composer2, (Object) ((SkippableUpdater) obj).m2785unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2781equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m2782hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2783toStringimpl(Composer composer2) {
        return "SkippableUpdater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m2780equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2782hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2783toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2785unboximpl() {
    ...
    public static final void m2784updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.startReplaceableGroup(509942095);
        block.invoke(Updater.m2786boximpl(Updater.m2787constructorimpl(arg0)));

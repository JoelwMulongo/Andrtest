...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long m2806alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m6146getWidthimpl(space) - IntSize.m6146getWidthimpl(size), IntSize.m6145getHeightimpl(space) - IntSize.m6145getHeightimpl(size));
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((this.horizontalBias + f) * (((float) IntSize.m6146getWidthimpl(remaining)) / 2.0f)), MathKt.roundToInt((f + this.verticalBias) * (((float) IntSize.m6145getHeightimpl(remaining)) / 2.0f)));
    }

...
public final class BiasAlignment implements Alignment {
    ...
    public long m2807alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float resolvedHorizontalBias;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float centerX = ((float) (IntSize.m6146getWidthimpl(space) - IntSize.m6146getWidthimpl(size))) / 2.0f;
        float centerY = ((float) (IntSize.m6145getHeightimpl(space) - IntSize.m6145getHeightimpl(size))) / 2.0f;

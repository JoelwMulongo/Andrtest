...
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public ZIndexModifier(float zIndex2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        super(inspectorInfo);
    ...
    public MeasureResult m2809measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), (Map) null, new ZIndexModifier$measure$1(placeable, this), 4, (Object) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (otherModifier != null && this.zIndex == otherModifier.zIndex) {
            return true;
        }
        return false;
    }

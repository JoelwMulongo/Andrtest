...
public final class ZIndexModifierKt$zIndex$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$zIndex_u24lambda_u240 = $this$null;
        $this$zIndex_u24lambda_u240.setName("zIndex");
        $this$zIndex_u24lambda_u240.setValue(Float.valueOf(this.$zIndex$inlined));
    }
}

...
public final class DrawModifierKt$drawWithCache$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$drawWithCache_u24lambda_u240 = $this$null;
        $this$drawWithCache_u24lambda_u240.setName("drawWithCache");
        $this$drawWithCache_u24lambda_u240.getProperties().set("onBuildDrawCache", this.$onBuildDrawCache$inlined);
    }
}

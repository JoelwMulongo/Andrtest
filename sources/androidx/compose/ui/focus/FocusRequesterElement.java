...
final class FocusRequesterElement extends ModifierNodeElement<FocusRequesterModifierNodeImpl> {
    ...
    public FocusRequesterModifierNodeImpl update(FocusRequesterModifierNodeImpl node) {
        ...
        FocusRequesterModifierNodeImpl $this$update_u24lambda_u240 = node;
        $this$update_u24lambda_u240.getFocusRequester().getFocusRequesterNodes$ui_release().remove($this$update_u24lambda_u240);
        $this$update_u24lambda_u240.setFocusRequester(this.focusRequester);
        $this$update_u24lambda_u240.getFocusRequester().getFocusRequesterNodes$ui_release().add($this$update_u24lambda_u240);
        return node;
    }

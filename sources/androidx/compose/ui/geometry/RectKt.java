...
public final class RectKt {
    ...
    public static final Rect m2955Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m2915getXimpl(offset), Offset.m2916getYimpl(offset), Offset.m2915getXimpl(offset) + Size.m2984getWidthimpl(size), Offset.m2916getYimpl(offset) + Size.m2981getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m2953Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m2915getXimpl(topLeft), Offset.m2916getYimpl(topLeft), Offset.m2915getXimpl(bottomRight), Offset.m2916getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m2954Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m2915getXimpl(center) - radius, Offset.m2916getYimpl(center) - radius, Offset.m2915getXimpl(center) + radius, Offset.m2916getYimpl(center) + radius);
    }

...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m3022actualTintColorFilterxETnrds(long color, int blendMode) {
        ColorFilter androidColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m3099BlendModeColorFilterxETnrds(color, blendMode);
        } else {
            androidColorFilter = new PorterDuffColorFilter(ColorKt.m3218toArgb8_81llA(color), AndroidBlendMode_androidKt.m3008toPorterDuffModes9anfk8(blendMode));
        }
        return new ColorFilter(androidColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m3020actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m3021actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m3218toArgb8_81llA(multiply), ColorKt.m3218toArgb8_81llA(add)));
    }
}

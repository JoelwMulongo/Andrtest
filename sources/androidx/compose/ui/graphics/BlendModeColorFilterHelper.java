...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m3099BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m3218toArgb8_81llA(color), AndroidBlendMode_androidKt.m3007toAndroidBlendModes9anfk8(blendMode));
    }
}

        ...
        if (!orderMethodsFetched) {
            try {
                if (Build.VERSION.SDK_INT == 28) {
                    ...
                    Method getDeclaredMethod = cls.getDeclaredMethod("getDeclaredMethod", new Class[]{String.class, new Class[0].getClass()});
                    reorderBarrierMethod = (Method) getDeclaredMethod.invoke(Canvas.class, new Object[]{"insertReorderBarrier", new Class[0]});
                    inorderBarrierMethod = (Method) getDeclaredMethod.invoke(Canvas.class, new Object[]{"insertInorderBarrier", new Class[0]});
                } else {

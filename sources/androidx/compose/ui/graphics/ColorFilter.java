...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m3205tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m3095getSrcIn0nO6VwU();
            }
            return companion.m3208tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m3208tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m3022actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m3206colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m3020actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m3207lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m3021actualLightingColorFilterOWjLjI(multiply, add);
        }
    }

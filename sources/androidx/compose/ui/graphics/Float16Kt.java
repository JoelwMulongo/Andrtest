...
public final class Float16Kt {
    ...
    public static final short m3306minAoSsdG0(short x, short y) {
        if (Float16.m3278isNaNimpl(x) || Float16.m3278isNaNimpl(y)) {
            return Float16.Companion.m3300getNaNslo4al4();
        }
        return Float16.m3265compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m3305maxAoSsdG0(short x, short y) {
        if (Float16.m3278isNaNimpl(x) || Float16.m3278isNaNimpl(y)) {
            return Float16.Companion.m3300getNaNslo4al4();
        }
        return Float16.m3265compareTo41bOqos(x, y) >= 0 ? x : y;

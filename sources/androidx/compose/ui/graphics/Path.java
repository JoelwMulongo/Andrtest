...
public interface Path {
    ...
    void m3442addPathUv8p0NA(Path path, long j);
    ...
    boolean m3444opN5in7k0(Path path, Path path2, int i);
    ...
    void m3445setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    void m3446translatek4lQ0M(long j);
    ...
    static /* synthetic */ void m3441addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m2931getZeroF1C5BW0();
            }
            path.m3442addPathUv8p0NA(path2, j);
            return;
        }
    ...
    public static final class Companion {
        ...
        public final Path m3447combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.m3444opN5in7k0(path1, path2, operation)) {
                return path;
            }

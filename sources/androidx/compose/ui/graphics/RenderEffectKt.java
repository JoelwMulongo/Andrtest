...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m3489BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.Companion.m3568getClamp3opZhB0();
        }
        return m3488BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs  reason: not valid java name */
    public static final BlurEffect m3488BlurEffect3YTHUZs(float radiusX, float radiusY, int edgeTreatment) {

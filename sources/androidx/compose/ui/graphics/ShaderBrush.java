...
public abstract class ShaderBrush extends Brush {
    private long createdSize = Size.Companion.m2992getUnspecifiedNHjbRc();
    private Shader internalShader;

    /* renamed from: createShader-uvyYCjk  reason: not valid java name */
    public abstract Shader m3503createShaderuvyYCjk(long j);
    ...
    public final void m3502applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2980equalsimpl0(this.createdSize, size)) {
            Shader it = m3503createShaderuvyYCjk(size);
            this.internalShader = it;
            shader = it;
            this.createdSize = size;
        }
        if (!Color.m3165equalsimpl0(p.m3421getColor0d7_KjU(), Color.Companion.m3190getBlack0d7_KjU())) {
            p.m3427setColor8_81llA(Color.Companion.m3190getBlack0d7_KjU());
        }

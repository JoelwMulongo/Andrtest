...
public final class StampedPathEffectStyle {
    ...
    public static final int Morph = m3531constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Rotate = m3531constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Translate = m3531constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3530boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3531constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3532equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m3536unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3533equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3534hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3532equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3534hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3539getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk  reason: not valid java name */
        public final int m3538getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk  reason: not valid java name */
        public final int m3537getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3535toStringimpl(int arg0) {
        if (m3533equalsimpl0(arg0, Translate)) {
            return "Translate";
        }
        if (m3533equalsimpl0(arg0, Rotate)) {
            return "Rotate";
        }
        if (m3533equalsimpl0(arg0, Morph)) {
            return "Morph";
        }
        return "Unknown";
    }
    ...
    public String toString() {
        return m3535toStringimpl(this.value);
    }
}

...
public final class VertexMode {
    ...
    public static final int TriangleFan = m3588constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int TriangleStrip = m3588constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Triangles = m3588constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ VertexMode m3587boximpl(int i) {
    ...
    public static boolean m3589equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).m3593unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3596getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI  reason: not valid java name */
        public final int m3595getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI  reason: not valid java name */
        public final int m3594getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3592toStringimpl(int arg0) {
        if (m3590equalsimpl0(arg0, Triangles)) {
            return "Triangles";
        }
        if (m3590equalsimpl0(arg0, TriangleStrip)) {
            return "TriangleStrip";
        }
        if (m3590equalsimpl0(arg0, TriangleFan)) {
            return "TriangleFan";
        }
        return "Unknown";
    }

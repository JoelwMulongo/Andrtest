...
public final class BitmapPainter extends Painter {
    ...
    private BitmapPainter(ImageBitmap image2, long srcOffset2, long srcSize2) {
        ...
        this.filterQuality = FilterQuality.Companion.m3259getLowfv9h1I();
        this.size = m3856validateSizeN5eqBDc(srcOffset2, srcSize2);
        this.alpha = 1.0f;
    }

    /* renamed from: getFilterQuality-f-v9h1I$ui_graphics_release  reason: not valid java name */
    public final int m3857getFilterQualityfv9h1I$ui_graphics_release() {
        return this.filterQuality;
    }

    /* renamed from: setFilterQuality-vDHp3xo$ui_graphics_release  reason: not valid java name */
    public final void m3859setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m3737drawImageAZ2fEMs$default($this$onDraw, this.image, this.srcOffset, this.srcSize, 0, IntSizeKt.IntSize(MathKt.roundToInt(Size.m2984getWidthimpl($this$onDraw.m3772getSizeNHjbRc())), MathKt.roundToInt(Size.m2981getHeightimpl($this$onDraw.m3772getSizeNHjbRc()))), this.alpha, (DrawStyle) null, this.colorFilter, 0, this.filterQuality, 328, (Object) null);
    }

    /* renamed from: getIntrinsicSize-NH-jbRc  reason: not valid java name */
    public long m3858getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m6156toSizeozmzZPI(this.size);
    }
    ...
    private final long m3856validateSizeN5eqBDc(long srcOffset2, long srcSize2) {
        if (IntOffset.m6104getXimpl(srcOffset2) >= 0 && IntOffset.m6105getYimpl(srcOffset2) >= 0 && IntSize.m6146getWidthimpl(srcSize2) >= 0 && IntSize.m6145getHeightimpl(srcSize2) >= 0 && IntSize.m6146getWidthimpl(srcSize2) <= this.image.getWidth() && IntSize.m6145getHeightimpl(srcSize2) <= this.image.getHeight()) {
            return srcSize2;
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BitmapPainter) && Intrinsics.areEqual((Object) this.image, (Object) ((BitmapPainter) other).image) && IntOffset.m6103equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m6144equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m3254equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.image.hashCode() * 31) + IntOffset.m6106hashCodeimpl(this.srcOffset)) * 31) + IntSize.m6147hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m3255hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + IntOffset.m6111toStringimpl(this.srcOffset) + ", srcSize=" + IntSize.m6149toStringimpl(this.srcSize) + ", filterQuality=" + FilterQuality.m3256toStringimpl(this.filterQuality) + ')';
    }
}

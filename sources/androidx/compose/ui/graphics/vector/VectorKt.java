...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m3458getNonZeroRgk1Os();
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m3547getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m3558getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m3095getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m3199getTransparent0d7_KjU();

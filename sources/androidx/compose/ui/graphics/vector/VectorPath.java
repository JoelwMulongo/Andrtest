...
public final class VectorPath extends VectorNode {
    ...
    public final int m3892getPathFillTypeRgk1Os() {
    ...
    public final int m3893getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m3894getStrokeLineJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.strokeLineWidth == ((VectorPath) other).strokeLineWidth) || !StrokeCap.m3543equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m3553equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if ((this.trimPathOffset == ((VectorPath) other).trimPathOffset) && PathFillType.m3453equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual((Object) this.pathData, (Object) ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((result2 + i) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m3544hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3554hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m3454hashCodeimpl(this.pathFillType);
    }
}

...
public final class KeyEvent {
    ...
    public static final /* synthetic */ KeyEvent m4507boximpl(android.view.KeyEvent keyEvent) {
        return new KeyEvent(keyEvent);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static android.view.KeyEvent m4508constructorimpl(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "nativeKeyEvent");
        return keyEvent;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4509equalsimpl(android.view.KeyEvent keyEvent, Object obj) {
        return (obj instanceof KeyEvent) && Intrinsics.areEqual((Object) keyEvent, (Object) ((KeyEvent) obj).m4513unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4510equalsimpl0(android.view.KeyEvent keyEvent, android.view.KeyEvent keyEvent2) {
        return Intrinsics.areEqual((Object) keyEvent, (Object) keyEvent2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4511hashCodeimpl(android.view.KeyEvent keyEvent) {
        return keyEvent.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4512toStringimpl(android.view.KeyEvent keyEvent) {
        return "KeyEvent(nativeKeyEvent=" + keyEvent + ')';
    }

    public boolean equals(Object obj) {
        return m4509equalsimpl(this.nativeKeyEvent, obj);
    }

    public int hashCode() {
        return m4511hashCodeimpl(this.nativeKeyEvent);
    }

    public String toString() {
        return m4512toStringimpl(this.nativeKeyEvent);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ android.view.KeyEvent m4513unboximpl() {

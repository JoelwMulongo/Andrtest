...
public final class KeyEventType {
    ...
    public static final int KeyDown = m4515constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int KeyUp = m4515constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Unknown = m4515constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ KeyEventType m4514boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4515constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4516equalsimpl(int i, Object obj) {
        return (obj instanceof KeyEventType) && i == ((KeyEventType) obj).m4520unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4517equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4518hashCodeimpl(int i) {
    ...
    public static String m4519toStringimpl(int arg0) {
        if (m4517equalsimpl0(arg0, KeyUp)) {
            return "KeyUp";
        }
        if (m4517equalsimpl0(arg0, KeyDown)) {
            return "KeyDown";
        }
        if (m4517equalsimpl0(arg0, Unknown)) {
            return "Unknown";
        }
        return "Invalid";
    }

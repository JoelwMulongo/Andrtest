...
public final class NestedScrollModifierKt {
    ...
    public static final Modifier nestedScroll(Modifier $this$nestedScroll, NestedScrollConnection connection, NestedScrollDispatcher dispatcher) {
        ...
        return ComposedModifierKt.composed($this$nestedScroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new NestedScrollModifierKt$nestedScroll$$inlined$debugInspectorInfo$1(connection, dispatcher) : InspectableValueKt.getNoInspectorInfo(), new NestedScrollModifierKt$nestedScroll$2(dispatcher, connection));
    }
}

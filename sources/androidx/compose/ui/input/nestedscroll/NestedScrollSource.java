...
public final class NestedScrollSource {
    ...
    public static final int Drag = m4559constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Fling = m4559constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Relocate = m4559constructorimpl(3);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m4558boximpl(int i) {
    ...
    public static boolean m4560equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).m4564unboximpl();
    }
    ...
    public final /* synthetic */ int m4564unboximpl() {
        return this.value;
    }
    ...
    public static String m4563toStringimpl(int arg0) {
        if (m4561equalsimpl0(arg0, Drag)) {
            return "Drag";
        }
        if (m4561equalsimpl0(arg0, Fling)) {
            return "Fling";
        }
        if (m4561equalsimpl0(arg0, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4565getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m4566getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI  reason: not valid java name */
        public final int m4567getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI  reason: not valid java name */
        public final int m4568getRelocateWNlRxjI() {

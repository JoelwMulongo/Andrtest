...
public final class PointerEvent_androidKt {
    public static final int EmptyPointerKeyboardModifiers() {
        return PointerKeyboardModifiers.m4730constructorimpl(0);
    }

    /* renamed from: isPrimaryPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4643isPrimaryPressedaHzCxE(int $this$isPrimaryPressed) {
        return ($this$isPrimaryPressed & 33) != 0;
    }

    /* renamed from: isSecondaryPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4645isSecondaryPressedaHzCxE(int $this$isSecondaryPressed) {
        return ($this$isSecondaryPressed & 66) != 0;
    }

    /* renamed from: isTertiaryPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4648isTertiaryPressedaHzCxE(int $this$isTertiaryPressed) {
        return ($this$isTertiaryPressed & 4) != 0;
    }

    /* renamed from: isBackPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4635isBackPressedaHzCxE(int $this$isBackPressed) {
        return ($this$isBackPressed & 8) != 0;
    }

    /* renamed from: isForwardPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4638isForwardPressedaHzCxE(int $this$isForwardPressed) {
        return ($this$isForwardPressed & 16) != 0;
    }

    /* renamed from: isPressed-bNIWhpI  reason: not valid java name */
    public static final boolean m4642isPressedbNIWhpI(int $this$isPressed_u2dbNIWhpI, int buttonIndex) {
        switch (buttonIndex) {
            case 0:
                return m4643isPrimaryPressedaHzCxE($this$isPressed_u2dbNIWhpI);
            case 1:
                return m4645isSecondaryPressedaHzCxE($this$isPressed_u2dbNIWhpI);
            case 2:
            case 3:
            case 4:
    ...
    public static final boolean m4630getAreAnyPressedaHzCxE(int $this$areAnyPressed) {
        return $this$areAnyPressed != 0;
    }

    /* renamed from: indexOfFirstPressed-aHzCx-E  reason: not valid java name */
    public static final int m4631indexOfFirstPressedaHzCxE(int $this$indexOfFirstPressed_u2daHzCx_u2dE) {
    ...
    public static final int m4632indexOfLastPressedaHzCxE(int $this$indexOfLastPressed_u2daHzCx_u2dE) {
        int index = -1;

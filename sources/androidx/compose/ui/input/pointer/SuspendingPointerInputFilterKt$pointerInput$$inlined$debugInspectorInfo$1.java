...
public final class SuspendingPointerInputFilterKt$pointerInput$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$pointerInput_u24lambda_u240 = $this$null;
        $this$pointerInput_u24lambda_u240.setName("pointerInput");
        $this$pointerInput_u24lambda_u240.getProperties().set("key1", this.$key1$inlined);
        $this$pointerInput_u24lambda_u240.getProperties().set("block", this.$block$inlined);
    }
}

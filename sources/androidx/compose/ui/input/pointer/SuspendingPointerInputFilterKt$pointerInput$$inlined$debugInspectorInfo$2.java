...
public final class SuspendingPointerInputFilterKt$pointerInput$$inlined$debugInspectorInfo$2 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$pointerInput_u24lambda_u241 = $this$null;
        $this$pointerInput_u24lambda_u241.setName("pointerInput");
        $this$pointerInput_u24lambda_u241.getProperties().set("key1", this.$key1$inlined);
        $this$pointerInput_u24lambda_u241.getProperties().set("key2", this.$key2$inlined);
        $this$pointerInput_u24lambda_u241.getProperties().set("block", this.$block$inlined);
    }
}

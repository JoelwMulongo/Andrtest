...
final class SuspendingPointerInputFilterKt$pointerInput$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(filter, this.$key1, new SuspendingPointerInputFilterKt$pointerInput$2$2$1(filter, this.$block, (Continuation<? super SuspendingPointerInputFilterKt$pointerInput$2$2$1>) null), $composer, 576);

...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.Companion.m2931getZeroF1C5BW0();
    ...
    public final long m4789getCurrentPointerPositionAccumulatorF1C5BW0$ui_release() {
        return this.currentPointerPositionAccumulator;
    }

    /* renamed from: setCurrentPointerPositionAccumulator-k-4lQ0M$ui_release  reason: not valid java name */
    public final void m4790setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA  reason: not valid java name */
    public final void m4787addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2915getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2916getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M  reason: not valid java name */
    public final long m4788calculateVelocity9UxMQ8M() {

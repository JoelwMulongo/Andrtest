...
public interface LookaheadLayoutCoordinates extends LayoutCoordinates {
    ...
    long m4855localLookaheadPositionOfR5De75A(LookaheadLayoutCoordinates lookaheadLayoutCoordinates, long j);

    /* renamed from: localLookaheadPositionOf-R5De75A$default  reason: not valid java name */
    static /* synthetic */ long m4854localLookaheadPositionOfR5De75A$default(LookaheadLayoutCoordinates lookaheadLayoutCoordinates, LookaheadLayoutCoordinates lookaheadLayoutCoordinates2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m2931getZeroF1C5BW0();
            }
            return lookaheadLayoutCoordinates.m4855localLookaheadPositionOfR5De75A(lookaheadLayoutCoordinates2, j);
        }

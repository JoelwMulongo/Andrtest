...
public final class LookaheadScope {
    ...
    public LookaheadScope(LayoutNode root2) {
    ...
    public final <T> T withDisposableSnapshot(Function0<? extends T> block) {
        ...
        if (this.disposableSnapshot == null) {
            MutableSnapshot it = Snapshot.Companion.takeMutableSnapshot$default(Snapshot.Companion, (Function1) null, (Function1) null, 3, (Object) null);

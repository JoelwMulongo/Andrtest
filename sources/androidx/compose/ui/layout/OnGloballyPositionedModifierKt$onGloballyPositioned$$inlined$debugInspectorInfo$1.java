...
public final class OnGloballyPositionedModifierKt$onGloballyPositioned$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$onGloballyPositioned_u24lambda_u240 = $this$null;
        $this$onGloballyPositioned_u24lambda_u240.setName("onGloballyPositioned");
        $this$onGloballyPositioned_u24lambda_u240.getProperties().set("onGloballyPositioned", this.$onGloballyPositioned$inlined);
    }
}

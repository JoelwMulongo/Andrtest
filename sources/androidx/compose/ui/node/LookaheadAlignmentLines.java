...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public long m5056calculatePositionInParentR5De75A(NodeCoordinator $this$calculatePositionInParent_u2dR5De75A, long position) {
        Intrinsics.checkNotNullParameter($this$calculatePositionInParent_u2dR5De75A, "$this$calculatePositionInParent");
        LookaheadDelegate lookaheadDelegate$ui_release = $this$calculatePositionInParent_u2dR5De75A.getLookaheadDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
        long $this$toOffset_u2d_u2dgyyYBs$iv = lookaheadDelegate$ui_release.m5059getPositionnOccac();
        return Offset.m2920plusMKHz9U(OffsetKt.Offset((float) IntOffset.m6104getXimpl($this$toOffset_u2d_u2dgyyYBs$iv), (float) IntOffset.m6105getYimpl($this$toOffset_u2d_u2dgyyYBs$iv)), position);
    }
}

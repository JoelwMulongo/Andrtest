...
final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m5084hit1hIXUjU((DelegatableNode) NodeCoordinatorKt.m5121nextUncheckedUntilhw7D004(this.$this_hit, this.$hitTestSource.m5119entityTypeOLwlOKw(), NodeKind.m5123constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}

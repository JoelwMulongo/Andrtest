...
final class NodeCoordinator$hitNear$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m5085hitNearJHbHoSQ((DelegatableNode) NodeCoordinatorKt.m5121nextUncheckedUntilhw7D004(this.$this_hitNear, this.$hitTestSource.m5119entityTypeOLwlOKw(), NodeKind.m5123constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}

...
final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m5087speculativeHitJHbHoSQ((DelegatableNode) NodeCoordinatorKt.m5121nextUncheckedUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.m5119entityTypeOLwlOKw(), NodeKind.m5123constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}

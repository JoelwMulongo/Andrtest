...
public final class SemanticsModifierNodeKt {
    ...
    public static final SemanticsConfiguration collapsedSemanticsConfiguration(SemanticsModifierNode $this$collapsedSemanticsConfiguration) {
        ...
        Modifier.Node localChild = DelegatableNodeKt.localChild($this$collapsedSemanticsConfiguration, NodeKind.m5123constructorimpl(8));
    ...
    public static final Rect touchBoundsInRoot(SemanticsModifierNode $this$touchBoundsInRoot) {
        ...
        if (!getUseMinimumTouchTarget($this$touchBoundsInRoot)) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4965requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5123constructorimpl(8)));
        }
        return DelegatableNodeKt.m4965requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5123constructorimpl(8)).touchBoundsInRoot();
    }
}

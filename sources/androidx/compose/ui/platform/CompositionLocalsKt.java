...
public final class CompositionLocalsKt {
    ...
    public static final void ProvideCommonCompositionLocals(Owner owner, UriHandler uriHandler, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        int $dirty = $changed;
        if (($changed & 14) == 0) {
            $dirty |= $composer2.changed((Object) owner) ? 4 : 2;
        }
        if (($changed & 112) == 0) {
            $dirty |= $composer2.changed((Object) uriHandler) ? 32 : 16;
        }
        if (($changed & 896) == 0) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalsKt$ProvideCommonCompositionLocals$1(owner, uriHandler, content, $changed));
        }
    }

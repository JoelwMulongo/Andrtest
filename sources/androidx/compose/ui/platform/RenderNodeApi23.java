...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m3248getAutoNrFUSI();
    private int left;
    ...
    public int m5269getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public void m5270setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m3244equalsimpl0(value, CompositingStrategy.Companion.m3250getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3244equalsimpl0(value, CompositingStrategy.Companion.m3249getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        if (CompositingStrategy.m3244equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m3250getOffscreenNrFUSI())) {
            return 2;
        }
        return 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m3125clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, (Object) null);
        }

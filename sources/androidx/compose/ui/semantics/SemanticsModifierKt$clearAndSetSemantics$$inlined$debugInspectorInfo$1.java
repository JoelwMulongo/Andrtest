...
public final class SemanticsModifierKt$clearAndSetSemantics$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$clearAndSetSemantics_u24lambda_u241 = $this$null;
        $this$clearAndSetSemantics_u24lambda_u241.setName("clearAndSetSemantics");
        $this$clearAndSetSemantics_u24lambda_u241.getProperties().set("properties", this.$properties$inlined);
    }
}

...
public final class AndroidTextStyle_androidKt {
    ...
    public static final PlatformParagraphStyle lerp(PlatformParagraphStyle start, PlatformParagraphStyle stop, float fraction) {
        ...
        return new PlatformParagraphStyle(((EmojiSupportMatch) SpanStyleKt.lerpDiscrete(EmojiSupportMatch.m5347boximpl(start.m5413getEmojiSupportMatch_3YsG6Y()), EmojiSupportMatch.m5347boximpl(stop.m5413getEmojiSupportMatch_3YsG6Y()), fraction)).m5353unboximpl(), ((Boolean) SpanStyleKt.lerpDiscrete(Boolean.valueOf(start.getIncludeFontPadding()), Boolean.valueOf(stop.getIncludeFontPadding()), fraction)).booleanValue(), (DefaultConstructorMarker) null);
    }

...
final class SaversKt$ShadowSaver$1 extends Lambda implements Function2<SaverScope, Shadow, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, Shadow it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m3154boximpl(it.m3516getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), $this$Saver), SaversKt.save(Offset.m2904boximpl(it.m3517getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), $this$Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
    }
}

...
final class SaversKt$SpanStyleSaver$1 extends Lambda implements Function2<SaverScope, SpanStyle, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, SpanStyle it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m3154boximpl(it.m5434getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(TextUnit.m6157boximpl(it.m5435getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(it.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), saverScope), SaversKt.save(it.m5436getFontStyle4Lr2A7w()), SaversKt.save(it.m5437getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(it.getFontFeatureSettings()), SaversKt.save(TextUnit.m6157boximpl(it.m5438getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(it.m5433getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), saverScope), SaversKt.save(it.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), saverScope), SaversKt.save(it.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), saverScope), SaversKt.save(Color.m3154boximpl(it.m5432getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(it.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), saverScope), SaversKt.save(it.getShadow(), SaversKt.getSaver(Shadow.Companion), saverScope));
    }
}

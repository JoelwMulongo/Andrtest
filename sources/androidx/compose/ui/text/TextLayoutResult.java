...
public final class TextLayoutResult {
    ...
    public final long m5447getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m6145getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m6146getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5446getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m5359getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m5448getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m5360getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m5444copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m5445copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m5445copyO0kMr_c(TextLayoutInput layoutInput2, long size2) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual((Object) this.layoutInput, (Object) ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual((Object) this.multiParagraph, (Object) ((TextLayoutResult) other).multiParagraph) || !IntSize.m6144equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m6147hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m6149toStringimpl(this.size) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}

...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5513getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m5563equalsimpl0(fontStyle, FontStyle.Companion.m5567getItalic_LCdwA()));
    }

...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int m5514getStyle_LCdwA() {
        return this.style;
    }

    private AndroidPreloadedFont(FontWeight weight2, int style2, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m5555getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, (DefaultConstructorMarker) null);
        this.weight = weight2;
        this.style = style2;
    }

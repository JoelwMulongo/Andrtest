...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m5472getMinimpl(selection);
        this.selectionEnd = TextRange.m5471getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m5472getMinimpl(selection);
        int end = TextRange.m5471getMaximpl(selection);
    ...
    public final TextRange m5616getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m5462boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m5617getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m5618updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m5472getMinimpl(newSelection));
        setSelectionEnd(TextRange.m5471getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long newComposition = EditingBufferKt.m5618updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), deleteRange);
            if (TextRange.m5468getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m5472getMinimpl(newComposition);
            this.compositionEnd = TextRange.m5471getMaximpl(newComposition);
        }
    }

...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange r0 = state.m5694getCompositionMzsxiRA();
            int compositionEnd = -1;
            int compositionStart = r0 != null ? TextRange.m5472getMinimpl(r0.m5478unboximpl()) : -1;
            TextRange r2 = state.m5694getCompositionMzsxiRA();
            if (r2 != null) {
                compositionEnd = TextRange.m5471getMaximpl(r2.m5478unboximpl());
            }
            inputMethodManager.updateSelection(TextRange.m5472getMinimpl(state.m5695getSelectiond9O1mEE()), TextRange.m5471getMaximpl(state.m5695getSelectiond9O1mEE()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5468getCollapsedimpl(this.mTextFieldValue.m5695getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        switch (editorAction) {
            case 0:
                imeAction = ImeAction.Companion.m5634getDefaulteUduSuo();
                break;
            case 2:
                imeAction = ImeAction.Companion.m5636getGoeUduSuo();
                break;
            case 3:
                imeAction = ImeAction.Companion.m5640getSearcheUduSuo();
                break;
            case 4:
                imeAction = ImeAction.Companion.m5641getSendeUduSuo();
                break;
            case 5:
                imeAction = ImeAction.Companion.m5637getNexteUduSuo();
                break;
            case 6:
                imeAction = ImeAction.Companion.m5635getDoneeUduSuo();
                break;
            case 7:
                imeAction = ImeAction.Companion.m5639getPreviouseUduSuo();
                break;
            default:
        ...
        this.eventCallback.m5649onImeActionKlQnJC8(imeAction);
        return true;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5472getMinimpl(this.mTextFieldValue.m5695getSelectiond9O1mEE()), reqModes);
    }

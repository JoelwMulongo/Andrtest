...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface m5702getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Typeface r0 = m5701buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    ...
    private final Typeface m5701buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m5563equalsimpl0(fontStyle, FontStyle.Companion.m5567getItalic_LCdwA()));
    }
}

...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual((Object) drawStyle2, (Object) Fill.INSTANCE)) {
                ...
                $this$updateDrawState_u24lambda_u240.setStrokeJoin(m5734toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3853getJoinLxFBmk8()));
                $this$updateDrawState_u24lambda_u240.setStrokeCap(m5733toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3852getCapKaPHkGw()));
    ...
    private final Paint.Join m5734toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        if (StrokeJoin.m3553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m3558getMiterLxFBmk8())) {
            return Paint.Join.MITER;
        }
        if (StrokeJoin.m3553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m3559getRoundLxFBmk8())) {
            return Paint.Join.ROUND;
        }
        if (StrokeJoin.m3553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m3557getBevelLxFBmk8())) {
    ...
    private final Paint.Cap m5733toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        if (StrokeCap.m3543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m3547getButtKaPHkGw())) {
            return Paint.Cap.BUTT;
        }
        if (StrokeCap.m3543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m3548getRoundKaPHkGw())) {
            return Paint.Cap.ROUND;
        }
        if (StrokeCap.m3543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m3549getSquareKaPHkGw())) {

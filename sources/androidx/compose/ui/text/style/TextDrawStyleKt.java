...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        ...
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m5869from8_81llA(ColorKt.m3215lerpjxsXWHM(start.m5868getColor0d7_KjU(), stop.m5868getColor0d7_KjU(), fraction));
        }
        if (!(start instanceof BrushStyle) || !(stop instanceof BrushStyle)) {
    ...
    public static final long m5867modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        return Color.m3163copywmQWz5c$default($this$modulate_u2dDxMtmZc, Color.m3166getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }

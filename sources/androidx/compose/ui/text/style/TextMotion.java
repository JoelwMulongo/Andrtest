...
public final class TextMotion {
    ...
    public static final TextMotion Animated = new TextMotion(Linearity.Companion.m5886getLinear4e0Vf04(), true, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final TextMotion Static = new TextMotion(Linearity.Companion.m5885getFontHinting4e0Vf04(), false, (DefaultConstructorMarker) null);
    ...
    public final int m5877getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m5875copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m5876copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m5876copyJdDtMQo$ui_text_release(int linearity2, boolean subpixelTextPositioning2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextMotion) && Linearity.m5881equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Linearity.m5882hashCodeimpl(this.linearity) * 31) + Boolean.hashCode(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
        /* access modifiers changed from: private */
        public static final int FontHinting = m5879constructorimpl(2);
        /* access modifiers changed from: private */
        public static final int Linear = m5879constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int None = m5879constructorimpl(3);
        private final int value;

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m5878boximpl(int i) {
        ...
        public static boolean m5880equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m5884unboximpl();
        }
        ...
        public static final class Companion {
            ...
            public final int m5886getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m5885getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m5887getNone4e0Vf04() {
        ...
        public static String m5883toStringimpl(int arg0) {
            if (m5881equalsimpl0(arg0, Linear)) {
                return "Linearity.Linear";
            }
            if (m5881equalsimpl0(arg0, FontHinting)) {
                return "Linearity.FontHinting";
            }
            if (m5881equalsimpl0(arg0, None)) {
                return "Linearity.None";
            }
            return "Invalid";
        }

...
public final class IntRectKt {
    ...
    public static final IntRect m6136IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m6104getXimpl(offset), IntOffset.m6105getYimpl(offset), IntOffset.m6104getXimpl(offset) + IntSize.m6146getWidthimpl(size), IntOffset.m6105getYimpl(offset) + IntSize.m6145getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m6135IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m6104getXimpl(topLeft), IntOffset.m6105getYimpl(topLeft), IntOffset.m6104getXimpl(bottomRight), IntOffset.m6105getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m6137IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m6104getXimpl(center) - radius, IntOffset.m6105getYimpl(center) - radius, IntOffset.m6104getXimpl(center) + radius, IntOffset.m6105getYimpl(center) + radius);
    }

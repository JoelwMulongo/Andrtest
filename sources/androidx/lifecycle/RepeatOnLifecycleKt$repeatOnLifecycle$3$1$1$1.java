...
final class RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1 implements LifecycleEventObserver {
    ...
    public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.ON_DESTROY) {
            ...
            this.$cont.resumeWith(Result.m6273constructorimpl(Unit.INSTANCE));
        }
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r11) {
            ...
            L_0x002f:
                kotlin.ResultKt.throwOnFailure(r11)
                r1 = r10
                kotlinx.coroutines.sync.Mutex r2 = r5
                kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> r3 = r6
                r4 = 0
                r5 = 0
                r6 = r1

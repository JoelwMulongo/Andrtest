    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r23) {
            ...
            L_0x004e:
                ...
                r7.<init>()
                r15 = r7
                androidx.lifecycle.Lifecycle$State r7 = r5     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.Lifecycle r14 = r4     // Catch:{ all -> 0x00f7 }
                kotlinx.coroutines.CoroutineScope r10 = r6     // Catch:{ all -> 0x00f7 }
                kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> r9 = r7     // Catch:{ all -> 0x00f7 }
                r16 = 0
                r2.L$0 = r6     // Catch:{ all -> 0x00f7 }
                r2.L$1 = r15     // Catch:{ all -> 0x00f7 }
                r2.L$2 = r7     // Catch:{ all -> 0x00f7 }
                r2.L$3 = r14     // Catch:{ all -> 0x00f7 }
                r2.L$4 = r10     // Catch:{ all -> 0x00f7 }
                r2.L$5 = r9     // Catch:{ all -> 0x00f7 }
                r2.label = r3     // Catch:{ all -> 0x00f7 }
                r8 = r2
                kotlin.coroutines.Continuation r8 = (kotlin.coroutines.Continuation) r8     // Catch:{ all -> 0x00f7 }
                r17 = r8
                r18 = 0
                kotlinx.coroutines.CancellableContinuationImpl r8 = new kotlinx.coroutines.CancellableContinuationImpl     // Catch:{ all -> 0x00f7 }
                kotlin.coroutines.Continuation r11 = kotlin.coroutines.intrinsics.IntrinsicsKt.intercepted(r17)     // Catch:{ all -> 0x00f7 }
                r8.<init>(r11, r3)     // Catch:{ all -> 0x00f7 }
                r19 = r8
                r19.initCancellability()     // Catch:{ all -> 0x00f7 }
                r12 = r19
                kotlinx.coroutines.CancellableContinuation r12 = (kotlinx.coroutines.CancellableContinuation) r12     // Catch:{ all -> 0x00f7 }
                r20 = 0
                androidx.lifecycle.Lifecycle$Event$Companion r8 = androidx.lifecycle.Lifecycle.Event.Companion     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.Lifecycle$Event r8 = r8.upTo(r7)     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.Lifecycle$Event$Companion r11 = androidx.lifecycle.Lifecycle.Event.Companion     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.Lifecycle$Event r11 = r11.downFrom(r7)     // Catch:{ all -> 0x00f7 }
                r7 = 0
                kotlinx.coroutines.sync.Mutex r13 = kotlinx.coroutines.sync.MutexKt.Mutex$default(r7, r3, r4)     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1 r7 = new androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1     // Catch:{ all -> 0x00f7 }
                r23 = r7
                r21 = r9
                r9 = r6
                r3 = r14
                r14 = r21
                r7.<init>(r8, r9, r10, r11, r12, r13, r14)     // Catch:{ all -> 0x00f7 }
                r7 = r23
                r15.element = r7     // Catch:{ all -> 0x00f7 }
                T r7 = r15.element     // Catch:{ all -> 0x00f7 }
                java.lang.String r9 = "null cannot be cast to non-null type androidx.lifecycle.LifecycleEventObserver"
                kotlin.jvm.internal.Intrinsics.checkNotNull(r7, r9)     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.LifecycleEventObserver r7 = (androidx.lifecycle.LifecycleEventObserver) r7     // Catch:{ all -> 0x00f7 }
                androidx.lifecycle.LifecycleObserver r7 = (androidx.lifecycle.LifecycleObserver) r7     // Catch:{ all -> 0x00f7 }
                r3.addObserver(r7)     // Catch:{ all -> 0x00f7 }
                java.lang.Object r3 = r19.getResult()     // Catch:{ all -> 0x00f7 }
                java.lang.Object r7 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ all -> 0x00f7 }
                if (r3 != r7) goto L_0x00d0
                r7 = r2
                kotlin.coroutines.Continuation r7 = (kotlin.coroutines.Continuation) r7     // Catch:{ all -> 0x00f7 }
                kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r7)     // Catch:{ all -> 0x00f7 }
            L_0x00d0:

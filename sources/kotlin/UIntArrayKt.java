...
public final class UIntArrayKt {
    private static final int[] UIntArray(int size, Function1<? super Integer, UInt> init) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = init.invoke(Integer.valueOf(i)).m6420unboximpl();
        }
        return UIntArray.m6423constructorimpl(iArr);
    }

    /* renamed from: uintArrayOf--ajY-9A  reason: not valid java name */
    private static final int[] m6439uintArrayOfajY9A(int... elements) {

...
public final class LineReader {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0021, code lost:
        if (kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r0.charset(), (java.lang.Object) r13) == false) goto L_0x0023;
     */
    ...
    public final synchronized java.lang.String readLine(java.io.InputStream r12, java.nio.charset.Charset r13) {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r13, r0)     // Catch:{ all -> 0x00d3 }
            java.nio.charset.CharsetDecoder r0 = decoder     // Catch:{ all -> 0x00d3 }
            r1 = 0
            if (r0 == 0) goto L_0x0023
            if (r0 != 0) goto L_0x0019
            java.lang.String r0 = "decoder"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r0)     // Catch:{ all -> 0x00d3 }
            r0 = r1
        L_0x0019:
            java.nio.charset.Charset r0 = r0.charset()     // Catch:{ all -> 0x00d3 }
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r0, (java.lang.Object) r13)     // Catch:{ all -> 0x00d3 }
            if (r0 != 0) goto L_0x0026
        L_0x0023:
            r11.updateCharset(r13)     // Catch:{ all -> 0x00d3 }
        L_0x0026:
            r0 = 0
            r2 = 0
        L_0x0028:
            int r3 = r12.read()     // Catch:{ all -> 0x00d3 }
            r4 = 32
            r5 = 10
            r6 = -1
            r7 = 1
        ...
        L_0x0043:
            ...
            return r1
        L_0x004b:
            int r1 = r11.decodeEndOfInput(r0, r2)     // Catch:{ all -> 0x00d3 }
            goto L_0x0080
        L_0x0050:
            byte[] r6 = bytes     // Catch:{ all -> 0x00d3 }
            int r9 = r0 + 1
            byte r10 = (byte) r3     // Catch:{ all -> 0x00d3 }
            r6[r0] = r10     // Catch:{ all -> 0x00d3 }
        ...
        L_0x0062:
            ...
            r0.limit(r9)     // Catch:{ all -> 0x00d3 }
            java.nio.CharBuffer r6 = charBuf     // Catch:{ all -> 0x00d3 }
            r6.position(r2)     // Catch:{ all -> 0x00d3 }
            int r6 = r11.decode(r8)     // Catch:{ all -> 0x00d3 }
            r2 = r6
            if (r2 <= 0) goto L_0x00cd
            char[] r6 = chars     // Catch:{ all -> 0x00d3 }
            int r10 = r2 + -1
            char r6 = r6[r10]     // Catch:{ all -> 0x00d3 }
            if (r6 != r5) goto L_0x00cd
            r0.position(r8)     // Catch:{ all -> 0x00d3 }
            r1 = r2
            r0 = r9
        L_0x0080:
            if (r1 <= 0) goto L_0x0098
            char[] r2 = chars     // Catch:{ all -> 0x00d3 }
            int r3 = r1 + -1
            char r3 = r2[r3]     // Catch:{ all -> 0x00d3 }
            if (r3 != r5) goto L_0x0098
            int r1 = r1 + -1
            if (r1 <= 0) goto L_0x0098
            int r3 = r1 + -1
            char r2 = r2[r3]     // Catch:{ all -> 0x00d3 }
            r3 = 13
            if (r2 != r3) goto L_0x0098
            int r1 = r1 + -1
        L_0x0098:
            java.lang.StringBuilder r2 = sb     // Catch:{ all -> 0x00d3 }
            r3 = r2
            java.lang.CharSequence r3 = (java.lang.CharSequence) r3     // Catch:{ all -> 0x00d3 }
        ...
        L_0x00a5:
            ...
            r2.<init>(r3, r8, r1)     // Catch:{ all -> 0x00d3 }
            monitor-exit(r11)
            return r2
        L_0x00b0:
            char[] r3 = chars     // Catch:{ all -> 0x00d3 }
            r2.append(r3, r8, r1)     // Catch:{ all -> 0x00d3 }
            java.lang.String r3 = r2.toString()     // Catch:{ all -> 0x00d3 }
            java.lang.String r5 = "sb.toString()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r5)     // Catch:{ all -> 0x00d3 }
            int r5 = r2.length()     // Catch:{ all -> 0x00d3 }
            if (r5 <= r4) goto L_0x00c8
            r11.trimStringBuilder()     // Catch:{ all -> 0x00d3 }
        L_0x00c8:
            r2.setLength(r8)     // Catch:{ all -> 0x00d3 }
            monitor-exit(r11)
            return r3
        L_0x00cd:
            int r0 = r11.compactBytes()     // Catch:{ all -> 0x00d3 }
            goto L_0x0028
        L_0x00d3:
            r12 = move-exception
            monitor-exit(r11)

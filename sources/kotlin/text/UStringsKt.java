...
public final class UStringsKt {
    ...
    public static final String m9toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m11toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m10toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m8toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m6341unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m6604unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m6420unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m6499unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m6420unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m6368constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m6285boximpl(UByte.m6291constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m6420unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m6368constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m6548boximpl(UShort.m6554constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m6368constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m6368constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m6368constructorimpl(UInt.m6368constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m6362boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m6447constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m6447constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m6447constructorimpl(ULong.m6447constructorimpl(((long) UInt.m6368constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m6441boximpl(result);
    }
}

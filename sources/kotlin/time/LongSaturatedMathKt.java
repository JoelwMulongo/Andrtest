...
public final class LongSaturatedMathKt {
    ...
    public static final long m165saturatingAddpTJri5U(long longNs, long duration) {
        long durationNs = Duration.m57getInWholeNanosecondsimpl(duration);
        boolean z = true;
        if (((longNs - 1) | 1) == Long.MAX_VALUE) {
            return m164checkInfiniteSumDefinedPjuGub4(longNs, duration, durationNs);
        }
        if ((1 | (durationNs - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m166saturatingAddInHalvespTJri5U(longNs, duration);
        }
    ...
    private static final long m164checkInfiniteSumDefinedPjuGub4(long longNs, long duration, long durationNs) {
        if (!Duration.m69isInfiniteimpl(duration) || (longNs ^ durationNs) >= 0) {
            return longNs;
        }
    ...
    private static final long m166saturatingAddInHalvespTJri5U(long longNs, long duration) {
        long half = Duration.m40divUwyO8pc(duration, 2);
        if ((1 | (Duration.m57getInWholeNanosecondsimpl(half) - 1)) == Long.MAX_VALUE) {
            return (long) (((double) longNs) + Duration.m80toDoubleimpl(duration, DurationUnit.NANOSECONDS));
        }
        return m165saturatingAddpTJri5U(m165saturatingAddpTJri5U(longNs, half), Duration.m72minusLRDsOJo(duration, half));
    }

    public static final long saturatingDiff(long valueNs, long originNs) {
        if ((1 | (originNs - 1)) == Long.MAX_VALUE) {
            return Duration.m89unaryMinusUwyO8pc(DurationKt.toDuration(originNs, DurationUnit.DAYS));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1Ns, long origin2Ns) {
        ...
        if (!(((origin2Ns - 1) | 1) == Long.MAX_VALUE)) {
            ...
            return Duration.m89unaryMinusUwyO8pc(DurationKt.toDuration(origin2Ns, DurationUnit.DAYS));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1Ns, long value2Ns) {
        ...
        if (((result ^ value1Ns) & (~(result ^ value2Ns))) < 0) {
            ...
            return Duration.m73plusLRDsOJo(duration, DurationKt.toDuration(resultNs, DurationUnit.NANOSECONDS));
        }

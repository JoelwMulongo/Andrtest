...
public interface TimeMark {
    ...
    TimeMark m174minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m175plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m177plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m176minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m175plusLRDsOJo(Duration.m89unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m70isNegativeimpl($this.m173elapsedNowUwyO8pc());
        }

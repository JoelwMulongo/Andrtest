...
public final class DelayKt {
    ...
    public static final Object m209delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m210toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m210toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m36compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m139getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m55getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}

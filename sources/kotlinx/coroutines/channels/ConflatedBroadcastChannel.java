...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public Object m246trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it != null) {
            return ChannelResult.Companion.m243closedJP2dKIU(it.getSendException());
        }
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x001e:
            ...
            boolean r7 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r7, r13, r4, r6)     // Catch:{ all -> 0x006d }

...
final class FlowKt__DelayKt$debounceInternal$1 extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:46:0x0128 A[Catch:{ all -> 0x0144 }] */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r20) {
        ...
        L_0x0108:
            ...
            r3.<init>(r14)
            r14 = r3
            kotlinx.coroutines.selects.SelectBuilder r14 = (kotlinx.coroutines.selects.SelectBuilder) r14     // Catch:{ all -> 0x0144 }
            r17 = 0
            T r4 = r10.element     // Catch:{ all -> 0x0144 }
            if (r4 == 0) goto L_0x0134
            long r4 = r0.element     // Catch:{ all -> 0x0144 }
            kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$1 r6 = new kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$1     // Catch:{ all -> 0x0144 }
            r6.<init>(r12, r10, r7)     // Catch:{ all -> 0x0144 }
            kotlin.jvm.functions.Function1 r6 = (kotlin.jvm.functions.Function1) r6     // Catch:{ all -> 0x0144 }
            r14.onTimeout(r4, r6)     // Catch:{ all -> 0x0144 }
        L_0x0134:
            kotlinx.coroutines.selects.SelectClause1 r0 = r11.getOnReceiveCatching()     // Catch:{ all -> 0x0144 }
            kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2 r4 = new kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2     // Catch:{ all -> 0x0144 }
            r4.<init>(r10, r12, r7)     // Catch:{ all -> 0x0144 }
            kotlin.jvm.functions.Function2 r4 = (kotlin.jvm.functions.Function2) r4     // Catch:{ all -> 0x0144 }
            r14.invoke(r0, r4)     // Catch:{ all -> 0x0144 }
            goto L_0x0148
        L_0x0144:
            r0 = move-exception
            r3.handleBuilderException(r0)

...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m265boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m266constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m268equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m274unboximpl());
    }
    ...
    public static String m273toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object obj) {
        return m268equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m271hashCodeimpl(this.holder);
    }

    public String toString() {
        return m273toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m267constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
    ...
    public static final Object m272plusFjFbRPM(Object arg0, E element) {
        if (DebugKt.getASSERTIONS_ENABLED() && ((element instanceof List) ^ 1) == 0) {
            throw new AssertionError();
        } else if (arg0 == null) {
            return m266constructorimpl(element);
        } else {
            if (!(arg0 instanceof ArrayList)) {
                ArrayList list = new ArrayList(4);
                list.add(arg0);
                list.add(element);
                return m266constructorimpl(list);
            } else if (arg0 != null) {
                ((ArrayList) arg0).add(element);
                return m266constructorimpl(arg0);
            } else {
    ...
    public static final void m270forEachReversedimpl(Object arg0, Function1<? super E, Unit> action) {
        if (arg0 != null) {
            if (!(arg0 instanceof ArrayList)) {
                action.invoke(arg0);
            } else if (arg0 != null) {
